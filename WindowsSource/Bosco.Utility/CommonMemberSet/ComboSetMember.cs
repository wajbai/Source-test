...
namespace Bosco.Utility.CommonMemberSet
{
    ...
    {
        public bool SelectComboItem(System.Windows.Forms.ComboBox dropDownCombo, string value, bool isValue)
        {
            bool isItem = false;
        ...
        public void BindDataCombo(System.Windows.Forms.ComboBox dropDownCombo, object dataSource, string listField, string valueField)
        {
            BindDataCombo(dropDownCombo, dataSource, listField, valueField, false, "");
        }

        private void BindDataCombo(System.Windows.Forms.ComboBox dropDownCombo, object dataSource, string listField, string valueField, bool isAddEmptyItem, string emptyItemName)
        {
        ...
        private void BindGridLookUpCombo(DevExpress.XtraEditors.GridLookUpEdit dropDownCombo, object dataSource, string listField, string valueField, bool isAddEmptyItem, string emptyItemName)
        {
            ...
            if (isAddEmptyItem)
            {
                ...
                if (dt.Columns.Contains(valueField) && dt.Columns.Contains(listField))
                {
                    dr = dt.NewRow();
                    dr[valueField] = 0;
                    dr[listField] = emptyItemName; //"<--All-->";
            ...
            dropDownCombo.Properties.ImmediatePopup = true;
            dropDownCombo.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.Standard;
            dropDownCombo.Properties.PopupFilterMode = DevExpress.XtraEditors.PopupFilterMode.Contains;
        }
        ...
        public void BindRepositoryItemCheckBoxGridLookUpEdit(DevExpress.XtraEditors.Repository.RepositoryItemCheckedComboBoxEdit rglkpEdit, object dataSource, string listField, string valueField)
        {
            rglkpEdit.DataSource = dataSource;
            rglkpEdit.DisplayMember = listField;
            rglkpEdit.ValueMember = valueField;
