...
INSERT INTO `master_country` (`COUNTRY_ID`,`COUNTRY`,`COUNTRY_CODE`,`CURRENCY_CODE`,`CURRENCY_SYMBOL`,`CURRENCY_NAME`) VALUES 
 ...
 INSERT INTO `master_country` (`COUNTRY_ID`,`COUNTRY`,`COUNTRY_CODE`,`CURRENCY_CODE`,`CURRENCY_SYMBOL`,`CURRENCY_NAME`) VALUES 
 (120,'Zambia','ZMB','ZMB','£','Zambian Kwacha'),
 (121,'Malawi','MWK','MWK','K','Malawian Kwacha'),
 (122,'Bostwana','BW','BW','P','Botswana Pula');
...
-- Salamon Raj 16.09.2016 
UPDATE MASTER_LEDGER_GROUP SET LEDGER_GROUP='Fixed Deposits_1',
ACCESS_FLAG=0 WHERE GROUP_ID <> 14 AND LEDGER_GROUP='Fixed Deposits';
UPDATE MASTER_LEDGER_GROUP SET LEDGER_GROUP = 'Fixed Deposits',
ACCESS_FLAG=2 WHERE GROUP_ID = 14;
UPDATE MASTER_LEDGER SET GROUP_ID=14,LEDGER_SUB_TYPE='FD',ACCESS_FLAG=2 WHERE LEDGER_ID=2;
...
CREATE TABLE `master_donor_title` (
  `TITLE_ID` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  `TITLE` VARCHAR(45) NOT NULL DEFAULT '',
  PRIMARY KEY(`TITLE_ID`))
ENGINE = InnoDB;
ALTER TABLE `master_donor_title` ADD UNIQUE `UNQ_TITLE`(`TITLE`);

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(1,'Mr') ON DUPLICATE KEY UPDATE TITLE_ID=1,TITLE='Mr';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(2,'Ms') ON DUPLICATE KEY UPDATE TITLE_ID=2,TITLE='Ms';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(3,'Mrs') ON DUPLICATE KEY UPDATE TITLE_ID=3,TITLE='Mrs';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(4,'Dr') ON DUPLICATE KEY UPDATE TITLE_ID=4,TITLE='Dr';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(5,'Prof') ON DUPLICATE KEY UPDATE TITLE_ID=5,TITLE='Prof';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(6,'Fr') ON DUPLICATE KEY UPDATE TITLE_ID=6,TITLE='Fr';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(7,'Sr') ON DUPLICATE KEY UPDATE TITLE_ID=7,TITLE='Sr';

INSERT INTO `master_donor_title`(TITLE_ID, TITLE)
VALUES(8,'Br') ON DUPLICATE KEY UPDATE TITLE_ID=8,TITLE='Br';

ALTER TABLE `master_donaud_reg_type` ADD INDEX `REGISTRATION_TYPE`(`REGISTRATION_TYPE`);

CREATE TABLE `master_donor_reference` (
  `REFERED_STAFF_ID` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  `REFERED_STAFF_NAME` VARCHAR(100) NOT NULL DEFAULT '',
  PRIMARY KEY(`REFERED_STAFF_ID`));

ALTER TABLE MASTER_DONAUD_PROSPECTS ADD COLUMN `TELEPHONE` VARCHAR(50) AFTER `PHONE`;

ALTER TABLE MASTER_DONAUD ADD COLUMN `TELEPHONE` VARCHAR(50) AFTER `PHONE`;

-- Suganthi 22-02-2016

UPDATE MASTER_LEDGER SET ACCESS_FLAG=2 WHERE LEDGER_ID IN (1,2,3);
...
INSERT  IGNORE
 INTO PROJECT_LEDGER
  ...
  (SELECT PROJECT_ID, F.LEDGER_ID
     FROM MASTER_PROJECT
     JOIN (SELECT LEDGER_ID FROM MASTER_LEDGER WHERE ACCESS_FLAG = 2) AS F
    GROUP BY PROJECT_ID, LEDGER_ID
    ORDER BY PROJECT_ID, LEDGER_ID);

INSERT INTO ACTIVITIY_RIGHTS(ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE)
VALUES(359,2,'Finnance Setting','FinanceSettings','Settings','Master Settings')
ON DUPLICATE KEY UPDATE PARENT_ID= 2,OBJECT_NAME='Finnance Setting',ENUMTYPE='FinanceSettings',OBJECT_TYPE='Settings',OBJECT_SUB_TYPE='Master Settings';
INSERT INTO ACTIVITIY_RIGHTS(ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE)
VALUES(360,2,'TDS Setting','TDSSetting','Settings','Master Settings')
 ON DUPLICATE KEY UPDATE PARENT_ID= 2,OBJECT_NAME='TDS Setting',ENUMTYPE='TDSSetting',OBJECT_TYPE='Settings',OBJECT_SUB_TYPE='Master Settings';
INSERT INTO ACTIVITIY_RIGHTS(ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE)
VALUES(361,2,'Asset Setting','AssetSetting','Settings','Master Settings')
 ON DUPLICATE KEY UPDATE PARENT_ID= 2,OBJECT_NAME='Asset Setting',ENUMTYPE='AssetSetting',OBJECT_TYPE='Settings',OBJECT_SUB_TYPE='Master Settings';
-- chinna M 01-02-2017
INSERT INTO ACTIVITIY_RIGHTS(ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE)
VALUES(362,89,'Delete Unused Ledgers','UnusedLedger','Data Utility','Activities')
 ON DUPLICATE KEY UPDATE PARENT_ID= 89,OBJECT_NAME='Delete Unused Ledgers',ENUMTYPE='UnusedLedger',OBJECT_TYPE='Data Utility',OBJECT_SUB_TYPE='Activities';
INSERT INTO ACTIVITIY_RIGHTS(ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE)
VALUES(363,89,'Move/ Delete Multiple Ledger','MoveDeleteMultipleLedgers','Data Utility','Activities')
 ON DUPLICATE KEY UPDATE PARENT_ID= 89,OBJECT_NAME='Move/ Delete Multiple Ledger',ENUMTYPE='MoveDeleteMultipleLedgers',OBJECT_TYPE='Data Utility',OBJECT_SUB_TYPE='Activities';

-- Sanjeev M 04-03-2016

ALTER TABLE `master_donaud_ins_type` ADD UNIQUE `UNQ_INSTITUTIONAL_TYPE` USING HASH(`INSTITUTIONAL_TYPE`);

ALTER TABLE `master_donor_reference` ADD UNIQUE `UNQ_REFERED_STAFF_NAME`(`REFERED_STAFF_NAME`);
...
INSERT INTO MASTER_LEDGER
(LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, BANK_ACCOUNT_ID, IS_COST_CENTER, IS_TDS_LEDGER, NOTES, IS_BANK_INTEREST_LEDGER, SORT_ID, STATUS,ACCESS_FLAG, IS_BRANCH_LEDGER, IS_INKIND_LEDGER, IS_DEPRECIATION_LEDGER,IS_ASSET_GAIN_LEDGER,IS_ASSET_LOSS_LEDGER)
VALUES ('IK001', 'In-Kind Donation Ledger', 5, 'GN', 'GN', 0, 0, 0, '', 0, 2, 0, 2, 0, 1, 0,0,0);

INSERT INTO MASTER_LEDGER
(LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, BANK_ACCOUNT_ID, IS_COST_CENTER, IS_TDS_LEDGER, NOTES, IS_BANK_INTEREST_LEDGER, SORT_ID, STATUS, ACCESS_FLAG, IS_BRANCH_LEDGER, IS_INKIND_LEDGER, IS_DEPRECIATION_LEDGER,IS_ASSET_GAIN_LEDGER,IS_ASSET_LOSS_LEDGER)
VALUES ('FA001', 'Fixed Asset Ledger', 11, 'GN', 'GN', 0, 0, 0, '',0, 2, 0, 2, 0, 0, 0, 0, 0);
...
--
-- Dumping data for table `networking`.`denomination`
--

/*!40000 ALTER TABLE `denomination` DISABLE KEYS */;
INSERT INTO `denomination` (`DENOMINATION_ID`,`DENOMINATION`) VALUES 
 (1,1),
 (2,2),
 (3,5),
 (4,10),
...
ALTER TABLE `master_ledger` ADD COLUMN `IS_SUBSIDY_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `IS_DISPOSAL_LEDGER`;

ALTER TABLE `master_donaud` ADD COLUMN `ECS_DURATION` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `TYPE`;

-- Report Setting for Voucher Print ( Added By Salamon)
...
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintCaptionBold','0');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintSign1Row1','Prepared By');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintSign1Row2','(Accountant)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintSign2Row1','Approved By');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintSign2Row2','(Authorised  Person)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintSign3Row1','(Affix Revenue Stamp)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintSign3Row2','Payee''s Signature');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-024','VoucherPrintValueBold','0');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintCaptionBold','0');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintSign1Row1','Prepared By');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintSign1Row2','(Accountant)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintSign2Row1','Approved By');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintSign2Row2','(Authorised  Person)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintSign3Row1','(Affix Revenue Stamp)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintSign3Row2','Receiver''s Signature');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-025','VoucherPrintValueBold','0');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintCaptionBold','0');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintSign1Row1','Prepared By');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintSign1Row2','(Accountant)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintSign2Row1','Approved By');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintSign2Row2','(Authorised  Person)');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintSign3Row1','');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintSign3Row2','');
INSERT INTO `master_report_setting` (`REPORT_ID`,`SETTING_NAME`,`VALUE`) VALUES ('RPT-026','VoucherPrintValueBold','0');
 ...
 WHERE LEDGER_ID IN
       (SELECT LEDGER_ID
          FROM (SELECT LB.LEDGER_ID
                 ...
                 WHERE TRANS_FLAG = 'OP'
                   AND ML.LEDGER_ID IS NULL) AS T);

-- Salamon (16.09.2016)
-- Delete Invalid Mapping in leader mapping with headoffice ledger
-- error 1: Head office mapping : Delete mapping if ledger is not exists in master ledger list
delete from headoffice_mapped_ledger
where ledger_id not in (SELECT ml.ledger_id FROM Master_ledger ml);

-- error 2: Head office mapping : Delete mapping if headoffice_ledger is not exists in master head offce ledger
delete from headoffice_mapped_ledger
WHERE headoffice_ledger_id not in (SELECT hl.headoffice_ledger_id FROM Master_headoffice_ledger hl);

-- error 3: Head office mapping : Delete mapping if same master ledger mapped with two head office ledger
DELETE FROM headoffice_mapped_ledger WHERE LEDGER_ID IN
(select ledger_id from (SELECT hml.ledger_id FROM headoffice_mapped_ledger hml
Group by hml.ledger_id having count(hml.ledger_id) >1) as t);

INSERT INTO BUDGET_TYPE
  (BUDGET_TYPE_ID, BUDGET_TYPE)
VALUES
  (3, 'Financial Year') ON DUPLICATE KEY UPDATE BUDGET_TYPE_ID = 3, BUDGET_TYPE = 'Financial Year';
INSERT INTO BUDGET_TYPE
  (BUDGET_TYPE_ID, BUDGET_TYPE)
VALUES
  (4, 'Calendar Year') ON DUPLICATE KEY UPDATE BUDGET_TYPE_ID = 4, BUDGET_TYPE = 'Calendar Year';

-- by aldrin on 18/10/16
ALTER TABLE `fd_renewal` ADD COLUMN `CLOSED_DATE` DATETIME AFTER `FD_TYPE`;
...
INSERT INTO `activitiy_rights` (`ACTIVITY_ID`,`PARENT_ID`,`OBJECT_NAME`,`ENUMTYPE`,`OBJECT_TYPE`,`OBJECT_SUB_TYPE`) VALUES 
 ...
 ALTER TABLE `master_donaud` ADD COLUMN `REGISTER_NO` VARCHAR(30) AFTER `NAME`,
 ADD COLUMN `DATE_OF_JOIN` DATETIME AFTER `OCCUPATION`,
 ADD COLUMN `DATE_OF_EXIT` DATETIME AFTER `DATE_OF_JOIN`;

 -- Fixed Asset Changes -----------------------------------------------------------------------------------------------
 -- Create Statements of all the Asset Tables

-- Asset Tables and DB Changes (03.02.2016)
...
insert into asset_dep_method (method_id,dep_method) values ('1','Straight Line Method');
insert into asset_dep_method (method_id,dep_method) values ('2','Written Down Method');
...
INSERT INTO `asset_class`(ASSET_CLASS, PARENT_CLASS_ID, DEP_PERCENTAGE, IMAGE_ID, METHOD_ID)
VALUES
('Primary',1,0.00,0,2),
('Land',1,0.00,0,2),
('Buildings',1,0.00,0,2),
('Vehicles',1,0.00,0,2),
('Fixtures & Fittings',1,0.00,0,2),
('Plant & Machinery',1,0.00,0,2),
('Office Equipments',1,0.00,0,2),
('Home Appliances',1,0.00,0,2),
('Software - Programs - licences',1,0.00,0,2),
('Other Tangible Assets',1,0.00,0,2),
('Other Intangible Assets',1,0.00,0,2);
...
INSERT INTO UOM (SYMBOL,NAME) VALUES('Nos','Numbers');
...
INSERT INTO MASTER_LEDGER
(LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, BANK_ACCOUNT_ID, IS_COST_CENTER, IS_TDS_LEDGER, NOTES, IS_BANK_INTEREST_LEDGER, SORT_ID, STATUS, ACCESS_FLAG, IS_BRANCH_LEDGER, IS_INKIND_LEDGER, IS_DEPRECIATION_LEDGER,IS_ASSET_GAIN_LEDGER,IS_ASSET_LOSS_LEDGER)
VALUES ('DP001', 'Depreciation Ledger', 8, 'GN', 'GN', 0, 0, 0, '',0, 2, 0, 2, 0, 0, 1, 0, 0);

ALTER TABLE `asset_item` ADD COLUMN `WIDTH` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `IS_ASSET_DEPRECIATION`;
...
ALTER TABLE `asset_item_detail` ADD COLUMN `SALVAGE_VALUE` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `BRANCH_ID`;

 -- end Asset changes ------------------------------------------------------------------------------------------------

 -- Payroll Database Changes ------------------------------------------------------------------------------------------
 -- Create statements of all payroll tables
...
INSERT INTO `prcomponent` (`COMPONENTID`,`COMPONENT`,`DESCRIPTION`,`TYPE`,`DEFVALUE`,`LINKVALUE`,`EQUATION`,`EQUATIONID`,`MAXSLAP`,`COMPROUND`,`IFCONDITION`,`SHOWINBROWSE`,`RELATEDCOMPONENTS`,`ISEDITABLE`,`ACCESS_FLAG`,`LEDGER_ID`,`PROCESS_TYPE_ID`,`PROCESS_DATE`) VALUES 
 (1,'BASIC','Basic Pay','0','0','Basicpay','','','0.00','1.00','0',0,'0.00',0,1,0,0,NULL),
 (2,'DA','Dearness Allowance','0','0','','<BASIC>*30/100','<1>*30/100~0~0','0.00','1.00','1',0,'ê1ê',1,1,0,0,NULL),
 (3,'HRA','House Rent Allowance','0','0','','<BASIC>*40/100','<1>*40/100~0~0','0.00','1.00','1',0,'ê1ê',1,1,0,0,NULL),
 (4,'EPF','Employees Provident Fund','1','0','','(<BASIC>+<DA>)*12/100','(<1>+<2>)*12/100~0~0','0.00','1.00','1',0,'ê1ê2ê',1,1,0,0,NULL),
 (5,'GROSS WAGES','GROSS SALARY','0','0','','<BASIC>+<DA>+<HRA>','<1>+<2>+<3>~0~0','0.00','1.00','1',0,'ê1ê2ê3ê',1,1,0,0,NULL),
 (6,'DEDUCTIONS','DEDUCTIONS','1','0','','<EPF>','<4>~0~0','0.00','1.00','1',0,'ê4ê',1,1,0,0,NULL),
 (7,'NETPAY','Net Payable Amount to the Employee','0','0','','<GROSS WAGES>-<DEDUCTIONS>','<5>-<6>~0~0','0.00','1.00','1',0,'ê5ê6ê',1,1,0,0,NULL);

INSERT INTO `prcomponent` (`COMPONENTID`,`COMPONENT`,`DESCRIPTION`,`TYPE`,`DEFVALUE`,`LINKVALUE`,`EQUATION`,`EQUATIONID`,`MAXSLAP`,`COMPROUND`,`IFCONDITION`,`SHOWINBROWSE`,`RELATEDCOMPONENTS`,`ISEDITABLE`,`ACCESS_FLAG`,`LEDGER_ID`,`PROCESS_TYPE_ID`,`PROCESS_DATE`) VALUES 
 (8,'NAME','Name of the Employee','2','0','Name','','','0.00','1.00','0',0,'0.00',1,1,0,0,NULL),
 (9,'DESIGNATION','DESIGNATION','2','0','Designation','','','0.00','1.00','0',0,'0.00',1,1,0,0,NULL);
  
/*!40000 ALTER TABLE `prcomponent` ENABLE KEYS */;

-- Commanded for creating ledger ( 25.03.2021)
...
ALTER TABLE `stfpersonal` ADD COLUMN `ACCOUNT_NUMBER` VARCHAR(45) AFTER `PAYINCM2`;
...
ALTER TABLE `stfpersonal` ADD COLUMN `THIRD_PARTY_ID` VARCHAR(30) AFTER `YOS`,
ADD INDEX `UNQ_THIRD_PARTY_ID`(`THIRD_PARTY_ID`);
...
ALTER TABLE `prcomponent` ADD COLUMN `PAYABLE` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '1-Payable,0-not payable' AFTER `PROCESS_DATE`;
...
ALTER TABLE `master_donaud_prospects` ADD COLUMN `REGISTER_NO` VARCHAR(30) AFTER `NAME`;

ALTER TABLE `master_lock_trans` ADD COLUMN `PASSWORD_HINT` VARCHAR(50) AFTER `REASON`;
...
ALTER TABLE `master_lock_trans` ADD COLUMN `LOCK_BY_PORTAL` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `PASSWORD_HINT`,
 ADD COLUMN `BRANCH_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `LOCK_BY_PORTAL`;

ALTER TABLE `fd_renewal` ADD COLUMN `TDS_AMOUNT` DOUBLE NOT NULL DEFAULT 0 AFTER `WITHDRAWAL_AMOUNT`;

UPDATE MASTER_SETTING SET VALUE = 2 WHERE SETTING_NAME = 'TransEntryMethod' AND VALUE NOT IN (1,2);


-- ---------------------------------------------------------GST---------------------------------------------------------------------------------

UPDATE MASTER_LEDGER_GROUP SET ACCESS_FLAG = 2 WHERE GROUP_ID = 24;-- 'Duties & Taxes'

INSERT INTO MASTER_LEDGER (LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, NOTES, ACCESS_FLAG)
VALUES('','Central Goods & Service Tax (CGST)', 24, 'GN','GN','', 2) ON DUPLICATE KEY UPDATE LEDGER_NAME = 'Central Goods & Service Tax (CGST)';

INSERT INTO MASTER_LEDGER (LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, NOTES, ACCESS_FLAG)
VALUES('','State Goods & Service Tax (SGST)', 24, 'GN','GN','', 2) ON DUPLICATE KEY UPDATE LEDGER_NAME = 'State Goods & Service Tax (SGST)';

INSERT INTO MASTER_LEDGER (LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, NOTES, ACCESS_FLAG)
VALUES('','Integrated Good & Service Tax (IGST)', 24, 'GN','GN','', 2) ON DUPLICATE KEY UPDATE LEDGER_NAME = 'Integrated Good & Service Tax (IGST)';

ALTER TABLE `master_insti_perference` ADD COLUMN `GST_NO` VARCHAR(30) AFTER `STATE_ID`;

ALTER TABLE `master_ledger` ADD COLUMN `IS_GST_LEDGERS` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `IS_SUBSIDY_LEDGER`;

ALTER TABLE `tds_credtiors_profile` ADD COLUMN `GST_Id` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `COUNTRY_ID`;

ALTER TABLE `tds_credtiors_profile` ADD COLUMN `NAME` VARCHAR(100) AFTER `GST_Id`;

ALTER TABLE `voucher_trans` ADD COLUMN `GST` DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER `LOCATION_ID`,
ADD COLUMN `CGST` DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER `GST`,
ADD COLUMN `SGST` DECIMAL (15,2) NOT NULL DEFAULT 0 AFTER `CGST`,
ADD COLUMN `IGST` DECIMAL (15,2) NOT NULL DEFAULT 0 AFTER `SGST`;

INSERT INTO PROJECT_LEDGER (PROJECT_ID, LEDGER_ID) (SELECT MP.PROJECT_ID , ML.LEDGER_ID FROM MASTER_LEDGER ML, MASTER_PROJECT MP
WHERE ML.LEDGER_NAME IN ('Central Goods & Service Tax (CGST)', 'State Goods & Service Tax (SGST)', 'Integrated Good & Service Tax (IGST)'))
ON DUPLICATE KEY UPDATE PROJECT_ID = MP.PROJECT_ID, LEDGER_ID = ML.LEDGER_ID;

ALTER TABLE `master_ledger` ADD COLUMN `GST_SERVICE_TYPE` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `IS_GST_LEDGERS`;

ALTER TABLE `tds_credtiors_profile` ADD COLUMN `GST_NO` VARCHAR(50) AFTER `GST_Id`;
...
INSERT INTO `master_gst_class` (`SLAB`,`GST`,`CGST`,`SGST`,`APPLICABLE_FROM`,`STATUS`,`SORT_ORDER`) VALUES
 ('GST05','5.00','2.50','2.50','2017-07-01 00:00:00',1,2),
 ('GST12','12.00','6.00','6.00','2017-07-01 00:00:00',1,3),
 ('GST0','0.00','0.00','0.00','2017-07-01 00:00:00',1,1),
 ('GST18','18.00','9.00','9.00','2017-07-01 00:00:00',1,4),
 ('GST28','28.00','14.00','14.00','2017-07-01 00:00:00',1,5);
...
INSERT INTO `master_setting_cheque_printing` (`BANK_ID`,`SETTING_NAME`,`SETTING_VALUE`) VALUES 
 (0,'AmountLeft','6.7'),
 (0,'AmountTop','1.5'),
 (0,'AmountWordsLeft','1.7'),
 (0,'AmountWordsTop','1.2'),
 (0,'DateDigitWidth','0.3'),
 (0,'DateLeft','6.5'),
 (0,'DateTop','0.3'),
 (0,'Height','3.10'),
 (0,'PartyNameLeft','0.15'),
 (0,'PartyNameTop','0.13'),
 (0,'Width','8');

-- On 03/10/2017, Update MATERIALIZED_ON = VOUCHER_DTAE for FD related Vouchers (Investment (From Bank), Interest (To Bank), Widthrwal (Full and partial))
UPDATE VOUCHER_TRANS VT INNER JOIN VOUCHER_MASTER_TRANS VM ON VM.VOUCHER_ID = VT.VOUCHER_ID
INNER JOIN MASTER_LEDGER ML ON ML.LEDGER_ID = VT.LEDGER_ID AND ML.GROUP_ID =12 AND VT.MATERIALIZED_ON IS NULL
SET VT.MATERIALIZED_ON = VM.VOUCHER_DATE WHERE VM.VOUCHER_SUB_TYPE='FD';

-- On 05/10/2017, Update Clsoed_date = RENEWAL_DATE (Widthdrwal Date) for all fully widthdrawn FDs alone
UPDATE FD_RENEWAL FR SET FR.CLOSED_DATE = FR.RENEWAL_DATE WHERE FR.FD_TYPE = 'WD' AND RENEWAL_TYPE = 'WDI' AND FR.CLOSED_DATE IS NULL;

ALTER TABLE `fd_account` ADD COLUMN `EXPECTED_MATURITY_VALUE` DECIMAL(15,2) NOT NULL DEFAULT 0.00 AFTER `NOTES`;

ALTER TABLE `fd_renewal` ADD COLUMN `EXPECTED_MATURITY_VALUE` DOUBLE NOT NULL DEFAULT 0 AFTER `TDS_AMOUNT`;

ALTER TABLE `master_donaud` MODIFY COLUMN `STATE_ID` INTEGER UNSIGNED;

ALTER TABLE voucher_trans
 ADD COLUMN CHEQUE_REF_DATE DATETIME NULL AFTER MATERIALIZED_ON,
 ADD COLUMN CHEQUE_REF_BANKNAME VARCHAR(50) AFTER CHEQUE_REF_DATE,
 ADD COLUMN CHEQUE_REF_BRANCH VARCHAR(50) AFTER CHEQUE_REF_BANKNAME;
...
ALTER TABLE `voucher_trans` DROP COLUMN `REFERENCE_JOURNAL_VOUCHER_ID`;

ALTER TABLE `voucher_trans` ADD COLUMN `REFERENCE_NUMBER` VARCHAR(60) AFTER `IGST`;

ALTER TABLE `voucher_trans` ADD UNIQUE `REFERENCE_NUMBER`(`REFERENCE_NUMBER`, `LEDGER_ID`);
...
INSERT INTO `budget_level` (`BUDGET_LEVEL_ID`,`BUDGET_LEVEL_NAME`) VALUES 
 (1,'Singular'),
 (2,'Composite');

ALTER TABLE `budget_master` DROP COLUMN `PROJECT_ID`,
DROP FOREIGN KEY `FK_budget_master_PROJECT_ID`;

ALTER TABLE `budget_master` ADD COLUMN `BUDGET_LEVEL_ID` INTEGER UNSIGNED NOT NULL DEFAULT 1 COMMENT '1-Singular 2 - Composite'
AFTER `DATE_TO`, ADD COLUMN `IS_MONTH_WISE` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0- No distribution, 1 - distributions' AFTER `DATE_TO`;

ALTER TABLE `budget_ledger` CHANGE COLUMN `AMOUNT` `PROPOSED_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00;

ALTER TABLE `budget_ledger` ADD COLUMN `APPROVED_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `PROPOSED_AMOUNT`;
...
ALTER TABLE `allot_fund` DROP COLUMN `MONTH1`,
 DROP COLUMN `MONTH2`,
 DROP COLUMN `MONTH3`,
 DROP COLUMN `MONTH4`,
 DROP COLUMN `MONTH5`,
...
ALTER TABLE `allot_fund` ADD COLUMN `PROJECT_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `LEDGER_ID`,
 ADD COLUMN `MONTH_YEAR` DATETIME NOT NULL DEFAULT 0 AFTER `PROJECT_ID`,
 ADD COLUMN `PROPOSED_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `MONTH_YEAR`,
 ADD COLUMN `APPROVED_AMOUNT` VARCHAR(45) NOT NULL DEFAULT '0.00' AFTER `PROPOSED_AMOUNT`,
 ADD INDEX `FK_PROJECT_ID`(`PROJECT_ID`);
...
INSERT INTO `master_statistics_type` (`STATISTICS_TYPE_ID`,`STATISTICS_TYPE`) VALUES
(5,'Boarding Boys'),
(6,'Boarding Girls'),
(2,'Brothers'),
(11,'Bus Driver & Cleaner'),
(9,'Domestic Staff'),
...
ALTER TABLE `master_ledger` ADD COLUMN `BUDGET_GROUP_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-Default 1-Recurring Expenses  2-NON - Recurring Expenses'
AFTER `GST_SERVICE_TYPE`, ADD COLUMN `BUDGET_SUB_GROUP_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-Default 1-Regular Expenses  2-Non Regular Expenses' AFTER `BUDGET_GROUP_ID`;

DROP TABLE IF EXISTS `tmp_ledger_budget_group`;

-- CREATE TABLE `tmp_ledger_budget_group` (
--  `LEDGER_NAME` varchar(100) NOT NULL DEFAULT '',
--  `BUDGET_GROUP` varchar(100) DEFAULT NULL,
--  `BUDGET_SUB_GROUP` varchar(100) DEFAULT NULL,
--  PRIMARY KEY (`LEDGER_NAME`)
-- ) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Advertisement Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('AICTE Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Alumni / Federation Expenditure','Recurring Expenses ','Non Regular Expenses'),
-- ('Annual Maintenance Charges','Recurring Expenses ','Non Regular Expenses'),
-- ('Audio & Video CD','Recurring Expenses ','Regular Expenses   '),
-- ('Audit Fee','Recurring Expenses ','Non Regular Expenses'),
-- ('Bank charges','Recurring Expenses ','Regular Expenses   '),
-- ('Books & Periodicals','Recurring Expenses ','Non Regular Expenses'),
-- ('Calendar & Hand Book','Recurring Expenses ','Non Regular Expenses'),
-- ('Candle Making Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Canteen Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Capital Fund','NON - Recurring Expenses',''),
-- ('Carpentry','Recurring Expenses ','Regular Expenses   '),
-- ('Catechetical Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Caution Deposit','NON - Recurring Expenses','');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Celebration & Feast Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Certificate Verification','Recurring Expenses ','Non Regular Expenses'),
-- ('Charity & Donations','Recurring Expenses ','Non Regular Expenses'),
-- ('Church Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Clothing & Footwear','Recurring Expenses ','Regular Expenses   '),
-- ('Commercial Tax','Recurring Expenses ','Non Regular Expenses'),
-- ('Computer Repair & Servicing','Recurring Expenses ','Regular Expenses   '),
-- ('Consultation Charges','Recurring Expenses ','Non Regular Expenses'),
-- ('Contract Staff Wages','Recurring Expenses ','Regular Expenses   '),
-- ('Contribution Given','Recurring Expenses ','Non Regular Expenses'),
-- ('Contribution to DB Tech','Recurring Expenses ','Non Regular Expenses'),
-- ('Contribution to Province','NON - Recurring Expenses',''),
-- ('Contribution to the Diocese','Recurring Expenses ','Regular Expenses   '),
-- ('Cultural & Youth Fest','Recurring Expenses ','Non Regular Expenses');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Customs Duty & Charges','Recurring Expenses ','Non Regular Expenses'),
-- ('Daily Wages','Recurring Expenses ','Regular Expenses   '),
-- ('Dairy & Poultry expenses','Recurring Expenses ','Regular Expenses   '),
-- ('DB-Tech Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('DBRS Continuum Medical Care Project Expenses (INM 12-095)','Recurring Expenses ','Regular Expenses   '),
-- ('DBRS Residential Care Project Expenses (INM 12-091)','Recurring Expenses ','Regular Expenses   '),
-- ('Department & Association Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Doctor & Medicine','Recurring Expenses ','Regular Expenses   '),
-- ('Domestic Articles & Furnishing','Recurring Expenses ','Regular Expenses   '),
-- ('Domestic Staff Salary','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - ASKE Training Centre - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - BCG - Chennai Flood Rehabilitations - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - BCG - Chennai Flood Response - Expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Don Bosco Anbu Illam - CFCI (Vellore) - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - CFCI (Vezlupuram) - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Child Friendly Space - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Child Line, Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Children Parliament, Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - DB - Tech - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - DBAI-FCRA - Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - DBAI-Local, Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Gratutity Account - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Homelink, Chennai - Expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Don Bosco Anbu Illam - ICPS - Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Misereor Foreign Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Misereor Local, Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - PF Account - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Police Boys & Girls Club - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Shelter for Homeless - Boys - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Shelter for Homeless - Girls - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Sponsorship Programme, Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Supplimentary Education - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Don Bosco Anbu Illam - Support Shelter - JDW, Chennai - Expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Don Bosco Anbu Illam -DBAI-SSA, Chennai - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('DOTE Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Educational Aid','Recurring Expenses ','Non Regular Expenses'),
-- ('Educational expenses of Salesians','Recurring Expenses ','Non Regular Expenses'),
-- ('Electrical Fittings & Sanitary Items','NON - Recurring Expenses',''),
-- ('Electricity Bill','Recurring Expenses ','Regular Expenses   '),
-- ('EPF Deducted / Remitted','Recurring Expenses ','Regular Expenses   '),
-- ('ESI Deducted / Remitted','Recurring Expenses ','Regular Expenses   '),
-- ('Establishment Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Examination Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Farm / Agricultural expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Feast & Celebrations','Recurring Expenses ','Non Regular Expenses'),
-- ('Fees paid to University','Recurring Expenses ','Non Regular Expenses'),
-- ('Fees Refunded','Recurring Expenses ','Non Regular Expenses');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Film & Entertainment','Recurring Expenses ','Regular Expenses   '),
-- ('Food & Provisions','Recurring Expenses ','Regular Expenses   '),
-- ('Fuel / Gas and Firewood','Recurring Expenses ','Regular Expenses   '),
-- ('Fuel for Vehicle','Recurring Expenses ','Regular Expenses   '),
-- ('Funeral & Cemetry Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Furniture & Fixtures','NON - Recurring Expenses',''),
-- ('Garden Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Generator Maintenance','Recurring Expenses ','Regular Expenses   '),
-- ('Gifts and Mementos','Recurring Expenses ','Non Regular Expenses'),
-- ('Group & Movements','Recurring Expenses ','Regular Expenses   '),
-- ('Hair Cut &Toilet Articles','Recurring Expenses ','Regular Expenses   '),
-- ('Hire Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Honorarium / Stipends / Incentives','Recurring Expenses ','Regular Expenses   '),
-- ('Hospitality expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Housing Aid','NON - Recurring Expenses',''),
-- ('I.D. Card / Tie / Belt','Recurring Expenses ','Non Regular Expenses'),
-- ('Inter Account Transfer','NON - Recurring Expenses',''),
-- ('Laboratory Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Laundry, Cleaning','Recurring Expenses ','Regular Expenses   '),
-- ('Library Books & Journals','Recurring Expenses ','Regular Expenses   '),
-- ('Life Insurance','Recurring Expenses ','Non Regular Expenses'),
-- ('Loan & Advance Given / Recovered','NON - Recurring Expenses',''),
-- ('Loan & Advance Taken / Returned','NON - Recurring Expenses',''),
-- ('Loan Interest','Recurring Expenses ','Regular Expenses   '),
-- ('Magazine Printing','Recurring Expenses ','Regular Expenses   '),
-- ('Maintenance of Copier/Fax etc','Recurring Expenses ','Regular Expenses   '),
-- ('Mass Stipend Transferred','Recurring Expenses ','Non Regular Expenses'),
-- ('Medical Aid','NON - Recurring Expenses',''),
-- ('Miscellaneous Expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Mission Sunday contribution','Recurring Expenses ','Non Regular Expenses'),
-- ('New Constructions','NON - Recurring Expenses',''),
-- ('News Paper & Magazine','Recurring Expenses ','Regular Expenses   '),
-- ('Night School/Oratory Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Office Consumables','Recurring Expenses ','Regular Expenses   '),
-- ('Office Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Old Age Home Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Over Time Payment to Workers','Recurring Expenses ','Regular Expenses   '),
-- ('Pastoral Ministry Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Picnic & Excursion','Recurring Expenses ','Non Regular Expenses'),
-- ('Placement Activities','Recurring Expenses ','Non Regular Expenses'),
-- ('Plant & Machinery','NON - Recurring Expenses',''),
-- ('Postage & Courier','Recurring Expenses ','Regular Expenses   '),
-- ('Press Expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Printing & Binding','Recurring Expenses ','Regular Expenses   '),
-- ('Printing & Xerox','Recurring Expenses ','Regular Expenses   '),
-- ('Professional Charges','Recurring Expenses ','Non Regular Expenses'),
-- ('Professional Tax','Recurring Expenses ','Non Regular Expenses'),
-- ('Programmes and Events','Recurring Expenses ','Non Regular Expenses'),
-- ('Property Tax','Recurring Expenses ','Non Regular Expenses'),
-- ('Purchase of Computer','NON - Recurring Expenses',''),
-- ('Purchase of Equipments','NON - Recurring Expenses',''),
-- ('Purchase of Land','NON - Recurring Expenses',''),
-- ('Purchase of Materials','Recurring Expenses ','Regular Expenses   '),
-- ('Purchase of Paper','Recurring Expenses ','Regular Expenses   '),
-- ('Purchase of Religious Articles','Recurring Expenses ','Regular Expenses   '),
-- ('Purchase of Vehicle','NON - Recurring Expenses',''),
-- ('Recognition Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Recreation / Pilgrimage','Recurring Expenses ','Non Regular Expenses');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Refreshment','Recurring Expenses ','Regular Expenses   '),
-- ('Remuneration paid for services','Recurring Expenses ','Regular Expenses   '),
-- ('Rent','Recurring Expenses ','Regular Expenses   '),
-- ('Repairs and Maintenance','Recurring Expenses ','Regular Expenses   '),
-- ('Repairs and Maintenance - Building','NON - Recurring Expenses',''),
-- ('Retreat & Seminar Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Salary - Non Teaching Staff','Recurring Expenses ','Regular Expenses   '),
-- ('Salary - Teaching Staff','Recurring Expenses ','Regular Expenses   '),
-- ('Sanitation Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Scholarship Disbursed','Recurring Expenses ','Non Regular Expenses'),
-- ('Security Services','Recurring Expenses ','Regular Expenses   '),
-- ('Service Station','Recurring Expenses ','Regular Expenses   '),
-- ('SMART Class Exp','Recurring Expenses ','Non Regular Expenses'),
-- ('SMS Services','Recurring Expenses ','Non Regular Expenses');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Society Registration / Renewal Charges','Recurring Expenses ','Non Regular Expenses'),
-- ('Software','NON - Recurring Expenses',''),
-- ('Software Renewal Charges','Recurring Expenses ','Non Regular Expenses'),
-- ('Sports and Games','Recurring Expenses ','Non Regular Expenses'),
-- ('Staff Association Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Staff Salary','Recurring Expenses ','Regular Expenses   '),
-- ('Staff Welfare','Recurring Expenses ','Regular Expenses   '),
-- ('Staff Welfare -Gratuity','Recurring Expenses ','Non Regular Expenses'),
-- ('Stationery','Recurring Expenses ','Regular Expenses   '),
-- ('Stipend Given for Holy Masses','Recurring Expenses ','Regular Expenses   '),
-- ('TDS Deducted / Remitted','NON - Recurring Expenses',''),
-- ('TDS Recover from IT Department','Recurring Expenses ','Non Regular Expenses'),
-- ('Tech Mahindra Foundation - Expenses','Recurring Expenses ','Regular Expenses   '),
-- ('Telephone & Internet Expenses','Recurring Expenses ','Regular Expenses   ');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Text Books & Note Books','Recurring Expenses ','Non Regular Expenses'),
-- ('Training Programme & Workshop Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Travel & Conveyance','Recurring Expenses ','Regular Expenses   '),
-- ('Uniform Fabric','Recurring Expenses ','Non Regular Expenses'),
-- ('University Affiliation Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('University Associations Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('University Examination Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('University Fee Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('University Recognition Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('University Registration Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Vehicle Maintenance','Recurring Expenses ','Regular Expenses   '),
-- ('Water Bill','Recurring Expenses ','Regular Expenses   '),
-- ('Water Tax','Recurring Expenses ','Non Regular Expenses');
-- INSERT INTO `tmp_ledger_budget_group` (`LEDGER_NAME`,`BUDGET_GROUP`,`BUDGET_SUB_GROUP`) VALUES 
-- ('Web Hosting Expenses','Recurring Expenses ','Non Regular Expenses'),
-- ('Welding Works','Recurring Expenses ','Regular Expenses   '),
-- ('Well & Water supply','NON - Recurring Expenses',''),
-- ('Youth Centre Expenses','Recurring Expenses ','Regular Expenses   ');

-- UPDATE MASTER_LEDGER ML INNER JOIN tmp_ledger_budget_group TMP ON TMP.LEDGER_NAME = ML.LEDGER_NAME
-- SET ML.BUDGET_GROUP_ID = CASE WHEN TRIM(TMP.BUDGET_GROUP) = 'Recurring Expenses' THEN 1 WHEN TRIM(TMP.BUDGET_GROUP) = 'NON - Recurring Expenses' THEN 2  ELSE 0 END,
-- ML.BUDGET_SUB_GROUP_ID = CASE WHEN TRIM(TMP.BUDGET_SUB_GROUP) = 'Regular Expenses' THEN 1 WHEN TRIM(TMP.BUDGET_SUB_GROUP) = 'Non Regular Expenses' THEN 2  ELSE 0 END;

UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Fixed Asset Ledger';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Depreciation Ledger';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Gain Ledger';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'In-Kind Ledger';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Loss Ledger';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Central Goods & Service Tax (CGST)';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Integrated Good & Service Tax (IGST)';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'State Goods & Service Tax (SGST)';
UPDATE MASTER_LEDGER SET ACCESS_FLAG = '2' WHERE LEDGER_NAME  = 'Interest on Staff Loan';

-- FD TDS Interest Included... 

INSERT INTO MASTER_LEDGER (LEDGER_CODE, LEDGER_NAME, GROUP_ID, LEDGER_TYPE, LEDGER_SUB_TYPE, NOTES, ACCESS_FLAG)
VALUES('','TDS on FD Interest', 11, 'GN','GN','', 2) ON DUPLICATE KEY UPDATE LEDGER_NAME = 'TDS on FD Interest' ,ACCESS_FLAG=2;

INSERT INTO PROJECT_LEDGER (PROJECT_ID, LEDGER_ID) (SELECT MP.PROJECT_ID , ML.LEDGER_ID FROM MASTER_LEDGER ML, MASTER_PROJECT MP
WHERE ML.LEDGER_NAME IN ('TDS on FD Interest'))
ON DUPLICATE KEY UPDATE PROJECT_ID = MP.PROJECT_ID, LEDGER_ID = ML.LEDGER_ID;

INSERT INTO MASTER_SETTING (SETTING_NAME, VALUE) VALUES ('CustomizationForm', 1);

-- UPDATE MASTER_SETTING SET VALUE =1 WHERE SETTING_NAME = 'CustomizationForm';

ALTER TABLE `fd_account` ADD COLUMN `FD_SCHEME` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-Normal,1-Flexi' AFTER `FD_ACCOUNT_NUMBER`;

ALTER TABLE `fd_renewal` ADD COLUMN `REINVESTED_AMOUNT` DOUBLE NOT NULL DEFAULT 0 AFTER `WITHDRAWAL_AMOUNT`;
...
CREATE TABLE  master_report_sign_detail (
  ...
  PRIMARY KEY (`ACC_YEAR_ID`,`SIGN_ORDER`),
  CONSTRAINT `FK_AC_REPORT_SIGN_DETAIL` FOREIGN KEY (`ACC_YEAR_ID`) REFERENCES `accounting_year` (`ACC_YEAR_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO BUDGET_TYPE (BUDGET_TYPE_ID,BUDGET_TYPE) VALUES (5,'Month') ON DUPLICATE KEY UPDATE BUDGET_TYPE_ID =5;

ALTER TABLE `budget_master` ADD COLUMN `BUDGET_ACTION` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0- Created  1 - Recommended 2- Approved'
AFTER `IS_ACTIVE`, ADD COLUMN `BRANCH_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `BUDGET_ACTION`;

ALTER TABLE `budget_ledger` MODIFY COLUMN `NARRATION` VARCHAR(500) CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE voucher_number_format MODIFY COLUMN NUMBER_FORMAT_ID INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '1-Voucher Number,2-Receipt Number,3-Contra Voucher Number, 4- Journal Voucher Number',
 ADD COLUMN VOUCHER_DEFINITION_ID INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Voucher Definition' AFTER PROJECT_ID;

ALTER TABLE voucher_master_trans ADD COLUMN VOUCHER_DEFINITION_ID INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Voucher Definition id' AFTER DONOR_SMS_SENT_DATE;

UPDATE VOUCHER_MASTER_TRANS SET VOUCHER_DEFINITION_ID = IF(VOUCHER_TYPE='RC', 1, IF(VOUCHER_TYPE='PY', 2, IF(VOUCHER_TYPE='CN', 3, 4)))
WHERE VOUCHER_DEFINITION_ID IS NULL OR VOUCHER_DEFINITION_ID = 0;

UPDATE VOUCHER_NUMBER_FORMAT SET VOUCHER_DEFINITION_ID = IF(NUMBER_FORMAT_ID = 2, 1, IF(NUMBER_FORMAT_ID = 1, 2, IF(NUMBER_FORMAT_ID = 3, 3, 4)))
WHERE VOUCHER_DEFINITION_ID IS NULL OR VOUCHER_DEFINITION_ID = 0;

ALTER TABLE `budget_ledger` ADD COLUMN `HO_NARRATION` VARCHAR(150) AFTER `NARRATION`;

ALTER TABLE VOUCHER_CC_TRANS ADD COLUMN LEDGER_SEQUENCE_NO INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER SEQUENCE_NO;

UPDATE VOUCHER_CC_TRANS AS VCC SET VCC.LEDGER_SEQUENCE_NO =
  IFNULL((SELECT SEQUENCE_NO FROM VOUCHER_TRANS VT WHERE VT.VOUCHER_ID = VCC.VOUCHER_ID AND VT.LEDGER_ID = VCC.LEDGER_ID LIMIT 1), 0 )
WHERE VCC.LEDGER_SEQUENCE_NO =0 OR VCC.LEDGER_SEQUENCE_NO IS NULL;

INSERT INTO MASTER_SETTING (SETTING_NAME, VALUE) VALUES ('MaxCashLedgerAmountInReceiptsPayments', 10000);

-- Few deletion in FD renewals (Partial Withdrawal) will not affecting in voucher master table
-- so this script will update status = 0 in voucher master table
UPDATE VOUCHER_MASTER_TRANS SET STATUS = 0 WHERE VOUCHER_SUB_TYPE = 'FD' AND STATUS = 1
AND VOUCHER_ID IN ( SELECT FD_VOUCHER_ID FROM FD_RENEWAL WHERE STATUS= 0 AND IS_DELETED = 0);

ALTER TABLE `asset_stock_vendor`
CHANGE COLUMN `NAME` `VENDOR` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';

UPDATE VOUCHER_MASTER_TRANS SET STATUS = 0 WHERE VOUCHER_SUB_TYPE = 'FD' AND STATUS = 1
AND VOUCHER_ID IN ( SELECT FD_INTEREST_VOUCHER_ID FROM FD_RENEWAL WHERE STATUS= 0 AND IS_DELETED = 0);

ALTER TABLE asset_stock_vendor ADD COLUMN GST_NO VARCHAR(25) DEFAULT NULL AFTER PAN_NO;

ALTER TABLE `asset_stock_vendor` MODIFY COLUMN `ADDRESS` VARCHAR(200) CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE voucher_master_trans
 ADD COLUMN GST_VENDOR_INVOICE_NO VARCHAR(25) DEFAULT NULL COMMENT 'Vendor GST invoice no' AFTER NARRATION,
 ADD COLUMN GST_VENDOR_INVOICE_DATE DATETIME DEFAULT NULL COMMENT 'Vendor GST invoice Date' AFTER GST_VENDOR_INVOICE_NO,
 ADD COLUMN GST_VENDOR_ID INTEGER UNSIGNED NULL COMMENT 'Vendor Name' AFTER GST_VENDOR_INVOICE_DATE,
 ADD CONSTRAINT FK_voucher_master_Vendor FOREIGN KEY FK_voucher_master_Vendor (GST_VENDOR_ID)
    REFERENCES asset_stock_vendor (VENDOR_ID)
    ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE voucher_master_trans
ADD COLUMN GST_VENDOR_INVOICE_TYPE
INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 - Regular, 1- Composition' AFTER GST_VENDOR_INVOICE_NO;

ALTER TABLE asset_stock_vendor MODIFY COLUMN GST_NO VARCHAR(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';
...
CREATE TABLE payroll_voucher (
 ...
 CONSTRAINT FK_payroll_voucher FOREIGN KEY (VOUCHER_ID) REFERENCES master_voucher (VOUCHER_ID),
...
ALTER TABLE `stfpersonal` ADD COLUMN `MIDDLE_NAME` VARCHAR(100) AFTER `DESIGNATION`,
 ADD COLUMN `FATHER_HUSBAND_NAME` VARCHAR(100) AFTER `MIDDLE_NAME`,
 ADD COLUMN `MOTHER_NAME` VARCHAR(100) AFTER `FATHER_HUSBAND_NAME`,
 ADD COLUMN `NO_OF_CHILDREN` VARCHAR(10) AFTER `MOTHER_NAME`,
 ADD COLUMN `BLOOD_GROUP` INTEGER UNSIGNED AFTER `NO_OF_CHILDREN`;

ALTER TABLE `stfpersonal` MODIFY COLUMN `BLOOD_GROUP` INTEGER UNSIGNED NOT NULL DEFAULT 0;

ALTER TABLE `stfpersonal` ADD COLUMN `LAST_DATE_OF_CONTRACT` DATETIME AFTER `THIRD_PARTY_ID`,
 ADD COLUMN `ADDRESS` VARCHAR(150) AFTER `LAST_DATE_OF_CONTRACT`,
 ADD COLUMN `TELEPHONE_NO` VARCHAR(50) AFTER `ADDRESS`,
 ADD COLUMN `MOBILE_NO` VARCHAR(10) AFTER `TELEPHONE_NO`,
 ADD COLUMN `EMERGENCY_CONTACT_NO` VARCHAR(10) AFTER `MOBILE_NO`,
 ADD COLUMN `EMAIL_ID` VARCHAR(50) AFTER `EMERGENCY_CONTACT_NO`,
 ADD COLUMN `DEPENDENT1` VARCHAR(150) AFTER `EMAIL_ID`,
 ADD COLUMN `DEPENDENT2` VARCHAR(150) AFTER `DEPENDENT1`,
 ADD COLUMN `DEPENDENT3` VARCHAR(150) AFTER `DEPENDENT2`,
 ADD COLUMN `WORK_EXPERIENCE` VARCHAR(150) AFTER `DEPENDENT3`,
 ADD COLUMN `PAN_NO` VARCHAR(20) AFTER `WORK_EXPERIENCE`,
 ADD COLUMN `AADHAR_NO` VARCHAR(20);

ALTER TABLE `stfpersonal` MODIFY COLUMN `BLOOD_GROUP` VARCHAR(10);

ALTER TABLE `stfservice` CHANGE COLUMN `PFNUMBER` `UAN` VARCHAR(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci;

ALTER TABLE prstafftemp MODIFY COLUMN COMPVALUE VARCHAR(350) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '';

ALTER TABLE prstaff MODIFY COLUMN COMPVALUE VARCHAR(350) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '';

ALTER TABLE stfservice ADD COLUMN GRADE_PAY DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER MAXWAGESHRA,
 ADD COLUMN OVERTIME_PAY DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER GRADE_PAY,
 ADD COLUMN PERFORMANCE_PAY DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER OVERTIME_PAY,
 ADD COLUMN SPECIAL_PAY DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER PERFORMANCE_PAY,
 ADD COLUMN DECREMENT_AMOUNT DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER SPECIAL_PAY,
 ADD COLUMN PAYING_SALARY_DAYS DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER DECREMENT_AMOUNT;

 ALTER TABLE stfservice CHANGE COLUMN GRADE_PAY EARNING1 DECIMAL(15,2) NOT NULL DEFAULT 0.00,
 CHANGE COLUMN OVERTIME_PAY EARNING2 DECIMAL(15,2) NOT NULL DEFAULT 0.00,
 CHANGE COLUMN PERFORMANCE_PAY EARNING3 DECIMAL(15,2) NOT NULL DEFAULT 0.00,
 CHANGE COLUMN SPECIAL_PAY DEDUCTION1 DECIMAL(15,2) NOT NULL DEFAULT 0.00,
 CHANGE COLUMN DECREMENT_AMOUNT DEDUCTION2 DECIMAL(15,2) NOT NULL DEFAULT 0.00;
 
ALTER TABLE prcomponent ADD COLUMN PROCESS_COMPONENT_TYPE INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'None=0, NetPay=1, GrossWages=2, Deductions=3' AFTER `PAYABLE`;

ALTER TABLE prloan ADD COLUMN IS_EXPENSE INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Is Loan component or Expense component' AFTER LOANABBRIVIATION;

ALTER TABLE payroll_voucher ADD COLUMN SALARY_GROUP_ID INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER PAYROLL_ID;

ALTER TABLE payroll_voucher DROP FOREIGN KEY FK_payroll_voucher,
 ADD CONSTRAINT FK_payroll_voucher_master FOREIGN KEY FK_payroll_voucher_master (VOUCHER_ID)
    REFERENCES voucher_master_trans (VOUCHER_ID)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT;
...
INSERT INTO prtext (TNAME) VALUES ('PayingSalaryDays');

INSERT INTO prloan (LOANNAME,LOANABBRIVIATION,IS_EXPENSE) VALUES ('Deduction1','Ded1',1);
INSERT INTO prloan (LOANNAME,LOANABBRIVIATION,IS_EXPENSE) VALUES ('Deduction2','Ded2',1);

-- 02.02.2023 for Reset the Allow and Modify
--UPDATE prcomponent  SET ISEDITABLE = 1;
--UPDATE prcomponent  SET ISEDITABLE = 0 WHERE (TRIM(LINKVALUE) = '' AND TRIM(EQUATION) = '')
--OR (FIND_IN_SET(LINKVALUE,  'Basicpay,Earning1,Earning2,Earning3,Deduction1,YOS,Deduction2,PayingSalaryDays'));

UPDATE PRTEXT SET TNAME='UAN' WHERE TNAME='PFNUMBER';
UPDATE prcomponent SET LINKVALUE = 'UAN' WHERE LINKVALUE ='PFNUMBER';

UPDATE prcomponent SET PROCESS_COMPONENT_TYPE=1 WHERE COMPONENT='NETPAY';
UPDATE prcomponent SET PROCESS_COMPONENT_TYPE=2 WHERE COMPONENT='GROSS WAGES';
UPDATE prcomponent SET PROCESS_COMPONENT_TYPE=3 WHERE COMPONENT='DEDUCTIONS';

DELETE FROM PRTEXT WHERE TNAME='Basic Pay';

DELETE FROM PRCOMPMONTH WHERE COMPONENTID IN (SELECT COMPONENTID FROM PRCOMPONENT WHERE COMPONENT='PAYING SALARY DAYS' AND TYPE=2 AND ACCESS_FLAG=1);
DELETE FROM PRCOMPONENT WHERE COMPONENT='PAYING SALARY DAYS' AND TYPE=2 AND ACCESS_FLAG=1;

UPDATE PRINCOME SET INCOME_NAME = 'Earning1' WHERE INCOME_NAME = 'GradePay';
UPDATE PRINCOME SET INCOME_NAME = 'Earning2' WHERE INCOME_NAME = 'OvertimePay';
UPDATE PRINCOME SET INCOME_NAME = 'Earning3' WHERE INCOME_NAME = 'PerformancePay';
DELETE FROM PRINCOME WHERE INCOME_NAME = 'SpecialPay';
DELETE FROM PRLOAN WHERE LOANNAME = 'DecrementAmount' AND IS_EXPENSE=1;
INSERT INTO PRLOAN (LOANNAME, LOANABBRIVIATION, IS_EXPENSE) VALUES ('Deduction2', 'DED2', 1);

ALTER TABLE budget_master ADD COLUMN HO_HELP_PROPOSED_AMOUNT decimal(15,2) NOT NULL DEFAULT 0.0 
COMMENT 'Head Office Help Propsed' AFTER BUDGET_ACTION, ADD COLUMN HO_HELP_APPROVED_AMOUNT decimal(15,2) NOT NULL DEFAULT 0.0 
COMMENT 'Head Office Help Approved' AFTER HO_HELP_PROPOSED_AMOUNT;

ALTER TABLE PRSTAFFTEMP DROP COLUMN ID;
ALTER TABLE PRSTAFF DROP COLUMN ID;

ALTER TABLE PRSTAFF ADD COLUMN ACTUAL_COMPVALUE VARCHAR(350) NOT NULL DEFAULT '' AFTER COMPVALUE;

ALTER TABLE voucher_trans ADD COLUMN LEDGER_GST_CLASS_ID INTEGER UNSIGNED NULL AFTER LOCATION_ID,
ADD CONSTRAINT FK_LEDGER_GST FOREIGN KEY FK_LEDGER_GST (LEDGER_GST_CLASS_ID)
   REFERENCES master_gst_class (GST_Id)
   ON DELETE RESTRICT
   ON UPDATE RESTRICT;
...
ALTER TABLE `asset_stock_vendor` ADD COLUMN `BRANCH_ID` INTEGER(10) UNSIGNED NOT NULL DEFAULT 0 AFTER `EMAIL_ID`;
...
CREATE TABLE  master_report_budget_new_projects (
  ...
  UNIQUE KEY UQ_NEW_PROJECT (NEW_PROJECT) USING BTREE,
...
CREATE TABLE `project_budget_ledger` (
  ...
  CONSTRAINT `FK_PBL_project_id` FOREIGN KEY `FK_PBL_project_id` (`PROJECT_ID`)
    REFERENCES `master_project` (`PROJECT_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `FK_PBL_ledger_id` FOREIGN KEY `FK_PBL_ledger_id` (`LEDGER_ID`)
    REFERENCES `master_ledger` (`LEDGER_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT);

INSERT INTO project_budget_ledger (PROJECT_ID, LEDGER_ID) (SELECT BP.PROJECT_ID, BL.LEDGER_ID
FROM BUDGET_LEDGER BL
INNER JOIN BUDGET_PROJECT BP ON BP.BUDGET_ID = BL.BUDGET_ID
LEFT JOIN project_budget_ledger PBL ON PBL.PROJECT_ID =BP.PROJECT_ID AND PBL.LEDGER_ID =BL.LEDGER_ID
WHERE PBL.PROJECT_ID IS NULL
GROUP BY BP.PROJECT_ID, BL.LEDGER_ID);

INSERT INTO PROJECT_BUDGET_LEDGER (PROJECT_ID, LEDGER_ID)
(SELECT BP.PROJECt_ID, BL.LEDGER_ID
FROM BUDGET_MASTER BM
INNER JOIN BUDGET_LEDGER BL ON BL.BUDGET_ID = BM.BUDGET_ID
INNER JOIN BUDGET_PROJECT BP ON BL.BUDGET_ID = BP.BUDGET_ID
LEFT JOIN PROJECT_BUDGET_LEDGER PBL ON PBL.PROJECT_ID = BP.PROJECT_ID AND PBL.LEDGER_ID = BL.LEDGER_ID
WHERE BM.IS_ACTIVE=1 AND PBL.LEDGER_ID IS NULL);

CREATE TABLE MASTER_SUB_LEDGER (
  SUB_LEDGER_ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  SUB_LEDGER_NAME VARCHAR(50) NOT NULL DEFAULT '',
  PRIMARY KEY(SUB_LEDGER_ID),
  UNIQUE UQ_SUB_LEDGER_NAME (SUB_LEDGER_NAME) USING BTREE
...
ALTER TABLE `voucher_master_trans` MODIFY COLUMN `CLIENT_CODE` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE master_report_sign_detail ADD COLUMN SIGN_IMAGE LONGBLOB AFTER ROLE;

INSERT INTO master_statistics_type (STATISTICS_TYPE) VALUES('Paying Guests');
INSERT INTO master_statistics_type (STATISTICS_TYPE) VALUES('Office Staff');
INSERT INTO master_statistics_type (STATISTICS_TYPE) VALUES('Catechists');
INSERT INTO master_statistics_type (STATISTICS_TYPE) VALUES('Touring Sisters');
INSERT INTO master_statistics_type (STATISTICS_TYPE) VALUES('Hostel Warden');
INSERT INTO master_statistics_type (STATISTICS_TYPE) VALUES('Driver'); 

-- update master_ledger set budget_group_id =2 where group_id not in (12,13,14) and budget_group_id not in (1);

ALTER TABLE `voucher_trans` MODIFY COLUMN `CHEQUE_NO` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci;

-- not able to DROP TABLE IF EXISTS `asset_stock_vendor`;
...
CREATE TABLE `asset_trans` (
 ...
 ALTER TABLE `asset_stock_manufacturer` ADD COLUMN `PAN_NO` VARCHAR(15) NOT NULL DEFAULT '' AFTER `EMAIL_ID`,
 ADD COLUMN `GST_NO` VARCHAR(25) NOT NULL DEFAULT '' AFTER `PAN_NO`;

 alter table asset_location drop INDEX LOCATION;

 ALTER TABLE `asset_location` ADD COLUMN `RESPONSIBLE_TO` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `BRANCH_ID`;
...
INSERT INTO `stock_category` (`CATEGORY_ID`,`CATEGORY_NAME`,`PARENT_CATEGORY_ID`) VALUES 
 (1,'Primary',1);
...
INSERT INTO `stock_group` (`GROUP_ID`,`GROUP_NAME`,`PARENT_GROUP_ID`) VALUES 
(1,'Primary',1);
...
INSERT INTO `asset_stock_vendor` (`VENDOR_ID`,`VENDOR`,`PAN_NO`,`ADDRESS`,`CONTACT_NO`,`EMAIL_ID`,`BRANCH_ID`) VALUES 
 ...
 ALTER TABLE `asset_stock_vendor` ADD UNIQUE `Vendore_Index`(`VENDOR`);

ALTER TABLE master_report_sign_detail ADD COLUMN `PROJECT_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `ACC_YEAR_ID`;
ALTER TABLE master_report_sign_detail DROP PRIMARY KEY, ADD PRIMARY KEY(`ACC_YEAR_ID`, `SIGN_ORDER`, `PROJECT_ID`);

ALTER TABLE master_report_budget_new_projects
 ADD COLUMN GN_HELP_PROPOSED_AMOUNT DOUBLE(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Proposed Government Fund' AFTER HO_HELP_APPROVED_AMOUNT,
 ADD COLUMN GN_HELP_APPROVED_AMOUNT DOUBLE(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Approved Government Fund' AFTER GN_HELP_PROPOSED_AMOUNT,
 ADD COLUMN INCLUDE_REPORTS INTEGER NOT NULL DEFAULT 1 COMMENT 'To include to the reports' AFTER GN_HELP_APPROVED_AMOUNT,
 ADD COLUMN REMARKS VARCHAR(100) NOT NULL DEFAULT ' ' AFTER INCLUDE_REPORTS;

ALTER TABLE `asset_item` ADD COLUMN `DEPRECIATION_NO` VARCHAR(15) NOT NULL DEFAULT '' AFTER `WIDTH`;
ALTER TABLE `asset_item` MODIFY COLUMN `DEPRECIATION_NO` VARCHAR(5) CHARACTER SET utf8 COLLATE utf8_general_ci;

INSERT INTO master_setting(SETTING_NAME)VALUES('ShowDepr');
...
INSERT INTO `budget_group` (`BUDGET_GROUP_ID`,`BUDGET_GROUP`) VALUES
 (0,'Primary'),
...
INSERT INTO `budget_sub_group` (`BUDGET_SUB_GROUP_ID`,`BUDGET_SUB_GROUP`) VALUES
 (0,'Primary'),
 (1,'Regular Expenses'),
 (2,'Non-Regular Expenses');

 ALTER TABLE `asset_item` ADD COLUMN `ASSET_ACCESS_FLAG`
INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-Accessable, 1-Editable, 2-Readonly' AFTER `DEPRECIATION_NO`;

ALTER TABLE MASTER_REPORT_SIGN_DETAIL ADD COLUMN HIDE_REQUIRE_SIGN_NOTE INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `SIGN_IMAGE`;

update voucher_trans set cheque_no = Replace(cheque_no, "\\", "") where instr(cheque_no, "\\");
update voucher_trans set cheque_no = Replace(cheque_no, "'", "") where instr(cheque_no, "'");

INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (370,0,'Asset','Asset','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (371,370,'Asset  Item','AssetItem','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (372,371,'Create Item','CreateItem','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (373,371,'Edit Item','EditItem','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (374,371,'Delete Item','DeleteItem','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (375,371,'View Item','ViewItem','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (376,370,'Vendor','Vendor','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (377,376,'Create Vendor','CreateVendor','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (378,376,'Edit Vendor','EditVendor','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (379,376,'Delete Vendor','DeleteVendor','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (380,376,'View Vendor','ViewVendor','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (381,370,'Manufacturer','Manufacturer','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (382,381,'Create Manufacturer','CreateManufacturer','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (383,381,'Edit Manufacturer','EditManufacturer','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (384,381,'Delete Manufacturer','DeleteManufacturer','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (385,381,'View Manufacturer','ViewManufacturer','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (386,370,'Custodian','Custodian','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (387,386,'Create Custodian','CreateCustodian','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (388,386,'Edit Custodian','EditCustodian','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (389,386,'Delete Custodian','DeleteCustodian','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (390,386,'View Custodian','ViewCustodian','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (391,370,'Block','Block','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (392,391,'Create Block','CreateBlock','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (393,391,'Edit Block','EditBlock','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (394,391,'Delete Block','DeleteBlock','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (395,391,'View Block','ViewBlock','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (396,370,'Location','Location','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (397,396,'Create Location','CreateLocation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (398,396,'Edit Location','EditLocation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (399,396,'Delete Location','DeleteLocation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (400,396,'View Location','ViewLocation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (401,370,'UoM','UoM','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (402,401,'Create UoM','CreateUoM','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (403,401,'Edit UoM','EditUoM','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (404,401,'Delete UoM','DeleteUoM','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (405,401,'View UoM','ViewUoM','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (406,370,'Opening Asset ','OpeningAsset','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (411,370,'Purchase ','Purchase ','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (412,411,'Creat Purchase ','CreatePurchase','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (413,411,'Edit Purchase ','EditPurchase','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (414,411,'Delete Purchase ','DeletePurchase','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (415,411,'View Purchase ','ViewPurchase','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (416,370,'Receive In-Kind','ReceiveInKind','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (417,416,'Create Receive In-Kind','CreateReceiveInKind','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (418,416,'Edit Receive In-Kind','EditReceiveInKind','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (419,416,'Delete Receive In-Kind','DeleteReceiveInKind','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (420,416,'View Receive In-Kind','ViewReceiveInKind','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (421,370,'Sales \ Disposal \ Donation','SalesDisposalDonation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (422,421,'Create Sales \ Disposal \ Donation','CreateSalesDisposalDonation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (423,421,'Edit Sales \ Disposal \ Donation','EditSalesDisposalDonation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (424,421,'Delete Sales \ Disposal \ Donation','DeleteSalesDisposalDonation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (425,421,'View Sales \ Disposal \ Donation','ViewSalesDisposalDonation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (426,370,'Depreciation','Depreciation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (427,426,'Create Depreciation','CreateDepreciation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (428,426,'Edit Depreciation','EditDepreciation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (429,426,'Delete Depreciation ','DeleteDepreciation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (430,426,'View Depreciation','ViewDepreciation','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (431,370,'Update Asset Details','UpdateAssetDetails','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (432,370,'Fixed Asset Register','FixedAssetRegister','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (433,370,'Map Asset Ledger','MapAssetLedger','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (434,370,'Import Opening Asset','ImportOpeningAsset','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (435,370,'Configure','Configure','Asset','Asset');
INSERT INTO ACTIVITIY_RIGHTS (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (436,196,'Asset','AssetReports','Asset','Asset');

CREATE TABLE `master_fund_transfer_type` (
  `FUND_TRANSFER_TYPE_ID` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  `FUND_TRANSFER_TYPE_NAME` VARCHAR(100) NOT NULL DEFAULT '',
  PRIMARY KEY(`FUND_TRANSFER_TYPE_ID`)
)
ENGINE = InnoDB;

ALTER TABLE `voucher_trans` ADD COLUMN `FUND_TRANSFER_TYPE_NAME` VARCHAR(60) AFTER `REFERENCE_NUMBER`;

INSERT INTO `master_fund_transfer_type` (`FUND_TRANSFER_TYPE_ID`,`FUND_TRANSFER_TYPE_NAME`) VALUES
 (1,'Cheque'),
 (2,'DD'),
 (3,'NEFT'),
 (4,'RTGS'),
...
INSERT INTO user_role (USERROLE) VALUES('Auditor') ON DUPLICATE KEY UPDATE USERROLE = 'Auditor';

INSERT INTO USER_INFO (FIRSTNAME, LASTNAME, USER_NAME, PASSWORD, NAME, ROLE_ID)
SELECT 'auditor' as FIRSTNAME, 'auditor' AS LASTNAME, 'auditor' AS USER_NAME,'nKewu4MohxupRxOGwiMN8Q==' AS PASSWORD,'auditor'AS NAME, USERROLE_ID
FROM USER_ROLE WHERE USERROLE = 'Auditor' ON DUPLICATE KEY UPDATE USER_NAME = 'auditor';

ALTER TABLE voucher_master_trans ADD COLUMN `IS_AUDITOR_MODIFIED`
INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Is Voucher modified or created by Auditor' AFTER MODIFIED_BY_NAME;

ALTER TABLE voucher_master_trans MODIFY COLUMN `MODIFIED_ON` DATETIME;

UPDATE VOUCHER_MASTER_TRANS SET MODIFIED_ON = NULL WHERE MODIFIED_ON='0000-00-00 00:00:00';
UPDATE VOUCHER_MASTER_TRANS SET CREATED_ON = NULL WHERE CREATED_ON ='0000-00-00 00:00:00';
UPDATE VOUCHER_MASTER_TRANS SET MODIFIED_BY=0, MODIFIED_BY_NAME='' WHERE MODIFIED_ON IS NULL;
UPDATE VOUCHER_MASTER_TRANS SET CREATED_BY=0, CREATED_BY_NAME='' WHERE CREATED_ON IS NULL;

ALTER TABLE voucher_master_trans MODIFY COLUMN `CREATED_BY_NAME` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
 MODIFY COLUMN `MODIFIED_BY_NAME` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';

ALTER TABLE stfpersonal ADD COLUMN ACCOUNT_IFSC_CODE VARCHAR(50) AFTER ACCOUNT_NUMBER,
ADD COLUMN ACCOUNT_BANK_BRANCH VARCHAR(150) AFTER ACCOUNT_IFSC_CODE;

INSERT INTO prtext (TNAME) VALUES ('TotalDaysInPayMonth');

INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME,ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (437,89,'Fixed Deposit Post Interest','FixedDepositPostInterest','Finance','Fixed Deposit Post Interest');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME,ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (438,437,'Create Interest Fixed Deposit','PostInterestFixedDeposit','Finance','Fixed Deposit Post Interest');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME,ENUMTYPE, OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (439,437,'Modify Interest Fixed Deposit','ModifyPostInterestFixedDeposit','Finance','Fixed Deposit Post Interest');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME,ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (440,437,'Delete Interest Fixed Deposit','DeletePostInterestFixedDeposit','Finance','Fixed Deposit Post Interest');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (441,437,'Print Fixed Deposit Post Interest','PrintFixedDepositPostInterest','Finance','Fixed Deposit Post Interest');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (442,89,'Fixed Deposit ReInvestment','FixedDepositReInvestment','Finance','Fixed Deposit ReInvestment');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (443,442,'Create ReInvestment','ReInvestmentFixedDeposit','Finance','Fixed Deposit ReInvestment');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (444,442,'Modify ReInvestment','ModifyFixedDepostReInvestment','Finance','Fixed Deposit ReInvestment');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (445,442,'Delete ReInvestment','DeleteFixedDepositReInvestment','Finance','Fixed Deposit ReInvestment');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (446,442,'Print ReInvestment','PrintFixedDepositReInvestment','Finance','Fixed Deposit ReInvestment');


ALTER TABLE MASTER_LEDGER ADD COLUMN DATE_CLOSED DATETIME AFTER ACCESS_FLAG;

UPDATE MASTER_BANK_ACCOUNT MBA
INNER JOIN MASTER_LEDGER ML ON ML.LEDGER_ID = MBA.LEDGER_ID
SET ML.DATE_CLOSED = MBA.DATE_CLOSED
WHERE MBA.DATE_CLOSED IS NOT NULL;
...
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (447,0,'Payroll','Payroll','Payroll','Payroll');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (448,447,'CreateNewPayrollMonth','CreateNewPayrollMonth','Payroll','CreateNewPayrollMonth');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (449,447,'Payroll Group','PayrollGroup','Payroll','Payroll Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (450,449,'Create Payroll Group','CreatePayrollGroup','Payroll','Payroll Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (451,449,'Edit Payroll Group','EditPayrollGroup','Payroll','Payroll Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (452,449,'Delete Payroll Group','DeletePayrollGroup','Payroll','Payroll Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (453,449,'View Payroll Group','ViewPayrollGroup','Payroll','Payroll Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (454,447,'Staff','Staff','Payroll','Staff');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (455,454,'Create Staff','CreateStaff','Payroll','Staff');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (456,454,'Edit Staff','EditStaff','Payroll','Staff');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (457,454,'Delete Staff','DeleteStaff','Payroll','Staff');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (458,454,'View Staff','ViewStaff','Payroll','Staff');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (459,447,'Payroll Component','PayrollComponent','Payroll','Payroll Component');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (460,459,'Create Payroll Component','CreatePayrollComponent','Payroll','Payroll Component');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (461,459,'Edit Payroll Component','EditPayrollComponent','Payroll','Payroll Component');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (462,459,'Delete Payroll Component','DeletePayrollComponent','Payroll','Payroll Component');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (463,459,'View Payroll Component','ViewPayrollComponent','Payroll','Payroll Component');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (464,447,'Loan','Loan','Payroll','Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (465,464,'Create Loan','CreateLoan','Payroll','Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (466,464,'Edit Loan','EditLoan','Payroll','Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (467,464,'Delete Loan','DeleteLoan','Payroll','Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (468,464,'View Loan','ViewLoan','Payroll','Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (469,447,'Issues Loan','IssuesLoan','Payroll','Issues Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (470,469,'Create Issues Loan','CreateIssuesLoan','Payroll','Issues Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (471,469,'Edit Issues Loan','EditIssuesLoan','Payroll','Issues Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (472,469,'DeleteI ssues Loan','DeleteIssuesLoan','Payroll','Issues Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (473,469,'View Issues Loan','ViewIssuesLoan','Payroll','Issues Loan');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (474,447,'Open Payroll Month','OpenPayrollMonth','Payroll','Open Payroll Month');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (475,447,'Delete Payroll Month','DeletePayrollMonth','Payroll','Delete Payroll Month');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (476,447,'component Allocation','componentAllocation','Payroll','component Allocation');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (477,447,'View Payroll','ViewPayroll','Payroll','View Payroll');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (478,447,'PostPayroll voucherto Finance Transaction','PostPayrollvouchertoFinanceTransaction','Payroll','PostPayroll voucherto Finance Transaction');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (479,196,'Payroll','PayrollReports','Payroll','Payroll');


INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (480,0,'Stock','Stock','Stock','Stock');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (481,480,'Stock Group','StockGroup','Stock','Stock Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (482,481,'Create Stock Group','CreateStockGroup','Stock','Stock Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (483,481,'Edit Stock Group','EditStockGroup','Stock','Stock Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (484,481,'Delete Stock Group','DeleteStockGroup','Stock','Stock Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (485,481,'View Stock Group','ViewStockGroup','Stock','Stock Group');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (486,480,'Stock Item','StockItem','Stock','Stock Item');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (487,486,'Create Stock Item','CreateStockItem','Stock','Stock Item');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (488,486,'Edit Stock Item','EditStockItem','Stock','Stock Item');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (489,486,'Delete Stock Item','DeleteStockItem','Stock','Stock Item');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (490,486,'View Stock Item','ViewStockItem','Stock','Stock Item');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (491,480,'Stock Vendor','StockVendor','Stock','Vendor');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (492,491,'Create Stock Vendor','CreateStockVendor','Stock','Vendor');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (493,491,'Edit Stock Vendor','EditStockVendor','Stock','Vendor');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (494,491,'Delete Stock Vendor','DeleteStockVendor','Stock','Vendor');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (495,491,'ViewStock Vendor','ViewStockVendor','Stock','Vendor');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (496,480,'Stock Custodian','StockCustodian','Stock','Custodian');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (497,496,'Create Stock Custodian','CreateStockCustodian','Stock','Custodian');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (498,496,'Edit Stock Custodian','EditStockCustodian','Stock','Custodian');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (499,496,'Delete Stock Custodian','DeleteStockCustodian','Stock','Custodian');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (500,496,'View Stock Custodian','ViewStockCustodian','Stock','Custodian');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (501,480,'Stock Block Area','StockBlockArea','Stock','Block \ Area');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (502,501,'Create StockBlock Area','CreateStockBlockArea','Stock','Block \ Area');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (503,501,'Edit StockBlock Area','EditStockBlockArea','Stock','Block \ Area');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (504,501,'Delete StockBlock Area','DeleteStockBlockArea','Stock','Block \ Area');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (505,501,'ViewStockBlock Area','ViewStockBlockArea','Stock','Block \ Area');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (506,480,'StockLocation','StockLocation','Stock','Location');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (507,506,'Create Stock Location','CreateStockLocation','Stock','Location');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (508,506,'Edit Stock Location','EditStockLocation','Stock','Location');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (509,506,'Delete Stock Location','DeleteStockLocation','Stock','Location');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (510,506,'View Stock Location','ViewStockLocation','Stock','Location');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (511,480,'StockUOM','StockUOM','Stock','UOM');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (512,511,'Create Stock UOM','CreateStockUOM','Stock','UOM');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (513,511,'Edit Stock UOM','EditStockUOM','Stock','UOM');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (514,511,'Delete Stock UOM','DeleteStockUOM','Stock','UOM');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (515,511,'ViewStock UOM','ViewStockUOM','Stock','UOM');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (516,480,'Opening Balance','OpeningBalance','Stock','Opening Balance');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (517,480,'Import Master','StockImportMaster','Stock','Import Master');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (518,480,'Stock Register','StockRegister','Stock','Stock Register');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (519,480,'Stock Purchase','StockPurchase','Stock','Purchase');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (520,519,'Create Stock Purchase','CreateStockPurchase','Stock','Purchase');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (521,519,'Edit Stock Purchase','EditStockPurchase','Stock','Purchase');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (522,519,'Delete Stock Purchase','DeleteStockPurchase','Stock','Purchase');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (523,519,'View Stock Purchase','ViewStockPurchase','Stock','Purchase');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (524,480,'Stock Receive Inkind','StockReceiveInkind','Stock','Receive In kind');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (525,524,'Create StockReceive Inkind','CreateStockReceiveInkind','Stock','Receive In kind');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (526,524,'Edit StockReceive Inkind','EditStockReceiveInkind','Stock','Receive In kind');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (527,524,'Delete StockReceive Inkind','DeleteStockReceiveInkind','Stock','Receive In kind');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (528,524,'ViewStockReceive Inkind','ViewStockReceiveInkind','Stock','Receive In kind');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (529,480,'Stock Stock Sales','StockStockSales','Stock','Sales');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (530,529,'Create Stock Sales','CreateStockSales','Stock','Sales');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (531,529,'Edit Stock Sales','EditStockSales','Stock','Sales');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (532,529,'Delete Stock Sales','DeleteStockSales','Stock','Sales');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (533,529,'View Stock Sales','ViewStockSales','Stock','Sales');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (534,480,'Stock Utilize','StockUtilize','Stock','Utilize');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (535,534,'Create Stock Utilize','CreateStockUtilize','Stock','Utilize');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (536,534,'Edit Stock Utilize','EditStockUtilize','Stock','Utilize');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (537,534,'Delete Stock Utilize','DeleteStockUtilize','Stock','Utilize');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (538,534,'View Stock Utilize','ViewStockUtilize','Stock','Utilize');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (539,480,'Stock Dispose','StockDispose','Stock','Dispose');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (540,539,'Create Stock Dispose','CreateStockDispose','Stock','Dispose');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (541,539,'Edit Stock Dispose','EditStockDispose','Stock','Dispose');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (542,539,'Delete Stock Dispose','DeleteStockDispose','Stock','Dispose');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (543,539,'View Stock  Dispose','ViewStockDispose','Stock','Dispose');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (544,480,'StockItem Transfer','StockItemTransfer','Stock','Item Transfer');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (545,544,'CreateStockItem Transfer','CreateStockItemTransfer','Stock','Item Transfer');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (546,544,'EditStockItem Transfer','EditStockItemTransfer','Stock','Item Transfer');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (547,544,'DeleteStockItem Transfer','DeleteStockItemTransfer','Stock','Item Transfer');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (548,544,'ViewStockItem Transfer','ViewStockItemTransfer','Stock','Item Transfer');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (549,480,'Stock Purchase Return','StockPurchaseReturn','Stock','Purchase Return');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (550,549,'Create StockPurchase Return','CreateStockPurchaseReturn','Stock','Purchase Return');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (551,549,'EditStockPurchase Return','EditStockPurchaseReturn','Stock','Purchase Return');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (552,549,'Delete StockPurchase Return','DeleteStockPurchaseReturn','Stock','Purchase Return');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (553,549,'View StockPurchase Return','ViewStockPurchaseReturn','Stock','Purchase Return');
INSERT INTO activitiy_rights (ACTIVITY_ID, PARENT_ID, OBJECT_NAME, ENUMTYPE,OBJECT_TYPE, OBJECT_SUB_TYPE) VALUES (554,196,'Stock','StockReports','Stock','Stock');

delete from budget_group where budget_group ="Primary";
delete from budget_sub_group where budget_sub_group ="Primary";
...
ALTER TABLE budget_group ADD COLUMN `BUDGET_GROUP_SORT_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `BUDGET_GROUP`;
ALTER TABLE budget_sub_group ADD COLUMN `BUDGET_SUB_GROUP_SORT_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `BUDGET_SUB_GROUP`;

INSERT INTO MASTER_STATISTICS_TYPE (STATISTICS_TYPE) VALUES('Guests');

ALTER TABLE prcomponent CHANGE COLUMN `SHOWINBROWSE` `DONT_SHOWINBROWSE` INTEGER UNSIGNED;

ALTER TABLE stfpersonal ADD COLUMN `ESI_IP_NO` VARCHAR(25) NOT NULL DEFAULT '' AFTER `AADHAR_NO`;
...
/*INSERT INTO `prcomponent` (`COMPONENT`, `DESCRIPTION`, `TYPE`, `DEFVALUE`, `LINKVALUE`, `EQUATION`,
`EQUATIONID`, `MAXSLAP`, `COMPROUND`, `IFCONDITION`, `DONT_SHOWINBROWSE`, `RELATEDCOMPONENTS`,
`ISEDITABLE`, `ACCESS_FLAG`, `LEDGER_ID`, `PROCESS_TYPE_ID`, `PROCESS_DATE`, `PAYABLE`, `PROCESS_COMPONENT_TYPE`) 
 VALUES ('TotalDays','Number of days in Pay Month','2','0','TotalDaysInPayMonth','','',0.00,0.00,'0',0,'0.00',0,1,0,0,'2021-01-31 00:00:00',0,0),
('WorkingDays','Number of working days in Pay Month','2','0','','','',0.00,0.00,'0',0,'0.00',0,1,0,0,'2021-01-31 00:00:00',0,0),
('LeaveDays','Number of Leave days in Pay Month','2','0','','','',0.00,0.00,'0',0,'0.00',0,1,0,0,'2021-01-31 00:00:00',0,0),
('LOPDays','Loss of Pay days in Pay Month','2','0','','','',0.00,0.00,'0',0,'0.00',0,1,0,0,'2021-01-31 00:00:00',0,0);*/

INSERT INTO prstaff_statutory_compliance (STAFF_ID, PAYROLL_ID, STATUTORY_COMPLIANCE)
SELECT * FROM (SELECT STAFFID AS STAFF_ID, PAYROLLID AS PAYROLL_ID, 4 AS STATUTORY_COMPLIANCE FROM PRCREATE PR JOIN stfpersonal SP UNION ALL
SELECT STAFFID AS STAFF_ID, PAYROLLID AS PAYROLL_ID, 5 AS STATUTORY_COMPLIANCE FROM PRCREATE PR JOIN stfpersonal SP UNION ALL
SELECT STAFFID AS STAFF_ID, PAYROLLID AS PAYROLL_ID, 6 AS STATUTORY_COMPLIANCE FROM PRCREATE PR JOIN stfpersonal SP) T
WHERE NOT EXISTS (SELECT STAFF_ID FROM prstaff_statutory_compliance);

ALTER TABLE `voucher_master_trans` ADD COLUMN `PREVIOUS_VOUCHER_NO` VARCHAR(25) NULL DEFAULT '' AFTER `IS_AUDITOR_MODIFIED`;

ALTER TABLE `voucher_master_trans` MODIFY COLUMN `CLIENT_REFERENCE_ID` VARCHAR(25);

ALTER TABLE `voucher_master_trans` MODIFY COLUMN `CLIENT_REFERENCE_ID` VARCHAR(100);

ALTER TABLE `voucher_master_trans` ADD COLUMN `CLIENT_MODE` VARCHAR(45) AFTER `CLIENT_CODE`;

ALTER TABLE `fd_renewal` ADD COLUMN `CHARGE_MODE` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-None, 1-Deduct from Interest 2- Deduct from Principal 3-Both' AFTER `TDS_AMOUNT`;
ALTER TABLE `fd_renewal` ADD COLUMN `CHARGE_AMOUNT` DOUBLE NOT NULL DEFAULT 0 AFTER `CHARGE_MODE`;
ALTER TABLE `fd_renewal` ADD COLUMN `CHARGE_LEDGER_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `CHARGE_AMOUNT`;

ALTER TABLE `fd_renewal` ADD COLUMN `EXPECTED_INTEREST_VALUE` DOUBLE NOT NULL DEFAULT 0 AFTER `EXPECTED_MATURITY_VALUE`;
ALTER TABLE `fd_account` ADD COLUMN `EXPECTED_INTEREST_VALUE` DOUBLE NOT NULL DEFAULT 0 AFTER `EXPECTED_MATURITY_VALUE`;
...
ALTER TABLE master_ledger ADD COLUMN `IS_BANK_SB_INTEREST_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-No,1-Yes' AFTER `IS_BANK_INTEREST_LEDGER`,
 ADD COLUMN `IS_BANK_COMMISSION_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-No,1-Yes' AFTER `IS_BANK_SB_INTEREST_LEDGER`;

-- UPDATE MASTER_COUNTRY SET CURRENCY_SYMBOL = COUNTRY_CODE WHERE CURRENCY_SYMBOL LIKE '%€%' OR CURRENCY_SYMBOL LIKE '%†%' OR CURRENCY_SYMBOL LIKE '%?%';
UPDATE MASTER_COUNTRY SET CURRENCY_SYMBOL = COUNTRY_CODE WHERE CURRENCY_SYMBOL LIKE '%†%' OR CURRENCY_SYMBOL LIKE '%?%';

ALTER TABLE `master_ledger` MODIFY COLUMN `LEDGER_CODE` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE `master_ledger_group` MODIFY COLUMN `GROUP_CODE` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci;
...
-- ALTER TABLE `master_ledger_group` ADD COLUMN `ALIAS_GROUP_CODE` VARCHAR(100) NOT NULL DEFAULT '' AFTER `GROUP_CODE`;

-- ALTER TABLE `master_ledger_group` MODIFY COLUMN `GROUP_CODE` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci;

-- ALTER TABLE `master_ledger` ADD COLUMN `ALIAS_LEDGER_CODE` VARCHAR(100) AFTER `LEDGER_CODE`;

-- ALTER TABLE `master_ledger` MODIFY COLUMN `LEDGER_CODE` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE `master_ledger` DROP COLUMN `ALIAS_LEDGER_CODE`;

ALTER TABLE `master_ledger_group` DROP COLUMN `ALIAS_GROUP_CODE`;

ALTER TABLE master_insti_perference ADD COLUMN EIGHTY_GNO_REG_DATE DATETIME AFTER EIGHTYGNO;

ALTER TABLE master_ledger ADD COLUMN `IS_BANK_FD_PENALTY_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-No,1-Yes' AFTER `IS_BANK_INTEREST_LEDGER`;

ALTER TABLE master_headoffice_ledger ADD COLUMN `IS_BANK_FD_PENALTY_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-No,1-Yes' AFTER `IS_BANK_INTEREST_LEDGER`,
 ADD COLUMN `IS_BANK_SB_INTEREST_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-No,1-Yes' AFTER `IS_BANK_FD_PENALTY_LEDGER`,
 ADD COLUMN `IS_BANK_COMMISSION_LEDGER` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-No,1-Yes' AFTER `IS_BANK_SB_INTEREST_LEDGER`;

ALTER TABLE `asset_class`
 ADD COLUMN `ACCESS_FLAG` INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER `METHOD_ID`;

UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Primary';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Land';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Buildings';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Vehicles';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Fixtures & Fittings';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Plant & Machinery';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Office Equipments';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Home Appliances';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Software - Programs - licences';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Other Tangible Assets';
UPDATE ASSET_CLASS SET ACCESS_FLAG =2 WHERE ASSET_CLASS = 'Other Intangible Assets';

ALTER TABLE `asset_project_location` ADD CONSTRAINT `FK_PROJECT_ID` FOREIGN KEY `FK_PROJECT_ID` (`PROJECT_ID`)
    REFERENCES `master_project` (`PROJECT_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT;

DELETE FROM asset_stock_vendor WHERE VENDOR = 'ERIC Solutions..';

ALTER TABLE `asset_custodian` DROP INDEX `CUSTODIAN`,
 ADD UNIQUE `CUSTODIAN` USING BTREE(`CUSTODIAN`, `ROLE`);

 
ALTER TABLE `asset_in_out_master` ADD COLUMN `TOT_DEP_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `VOUCHER_ID`;

ALTER TABLE `asset_in_out_detail`
ADD COLUMN `DEPRECIATION_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `QUANTITY`;

ALTER TABLE `asset_item_detail` ADD COLUMN `DEPRECIATION_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `ASSET_ID`;

ALTER TABLE `asset_trans` ADD COLUMN `DEPRECIATION_AMOUNT` DECIMAL(13,2) NOT NULL DEFAULT 0.00 AFTER `BRANCH_ID`;

--  ALTER TABLE `asset_in_out_master` MODIFY COLUMN `DONOR_ID` INTEGER;

--  ALTER TABLE `asset_in_out_master` ADD CONSTRAINT `FK_asset_Donor` FOREIGN KEY `FK_asset_Donor` (`DONOR_ID`)
--    REFERENCES `master_donaud` (`DONAUD_ID`)
--    ON DELETE RESTRICT
--    ON UPDATE RESTRICT;

--ALTER TABLE `asset_in_out_master` ADD CONSTRAINT `FK_asset_vendor` FOREIGN KEY `FK_asset_vendor` (`VENDOR_ID`)
--    REFERENCES `asset_stock_vendor` (`VENDOR_ID`)
--    ON DELETE RESTRICT
--    ON UPDATE RESTRICT;

--ALTER TABLE `asset_in_out_master` ADD CONSTRAINT `FK_asset_project` FOREIGN KEY `FK_asset_project` (`PROJECT_ID`)
--    REFERENCES `master_project` (`PROJECT_ID`)
--    ON DELETE RESTRICT
--    ON UPDATE RESTRICT;

--ALTER TABLE `asset_item_detail` ADD CONSTRAINT `FK_asset_Manufacturer` FOREIGN KEY `FK_asset_Manufacturer` (`MANUFACTURER_ID`)
--    REFERENCES `asset_stock_manufacturer` (`MANUFACTURER_ID`)
--    ON DELETE RESTRICT
--    ON UPDATE RESTRICT;

--ALTER TABLE `asset_item_detail` ADD CONSTRAINT `FK_asset_custodian` FOREIGN KEY `FK_asset_custodian` (`CUSTODIAN_ID`, `BRANCH_ID`)
--    REFERENCES `asset_custodian` (`CUSTODIAN_ID`, `BRANCH_ID`)
--    ON DELETE RESTRICT
--    ON UPDATE RESTRICT;

-- ALTER TABLE `asset_item_detail` ADD CONSTRAINT `FK_asset_location` FOREIGN KEY `FK_asset_location` (`LOCATION_ID`)
--    REFERENCES `asset_stock_location` (`LOCATION_ID`)
--    ON DELETE RESTRICT
--    ON UPDATE RESTRICT;


ALTER TABLE master_ledger ADD COLUMN `GST_HSN_SAC_CODE` VARCHAR(25) NOT NULL DEFAULT '' AFTER `GST_SERVICE_TYPE`;

ALTER TABLE master_state ADD COLUMN `STATE_CODE` VARCHAR(5) AFTER `STATE_ID`;

ALTER TABLE asset_stock_vendor ADD COLUMN `STATE_ID` INTEGER UNSIGNED AFTER `ADDRESS`,
 ADD CONSTRAINT `FK_asset_stock_State` FOREIGN KEY `FK_asset_stock_State` (`STATE_ID`)
    REFERENCES `master_state` (`STATE_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE asset_stock_vendor ADD COLUMN `COUNTRY_ID` INTEGER AFTER `STATE_ID`,
 ADD CONSTRAINT `FK_asset_stock_Country` FOREIGN KEY `FK_asset_stock_Country` (`COUNTRY_ID`)
    REFERENCES `master_COUNTRY` (`COUNTRY_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE `project_costcentre` ADD COLUMN `LEDGER_ID` INTEGER UNSIGNED NOT NULL COMMENT '0 - Costcentre for all Ledgers'
 DEFAULT 0 AFTER `PROJECT_ID`,
 DROP PRIMARY KEY, ADD PRIMARY KEY(`PROJECT_ID`, `LEDGER_ID`, `COST_CENTRE_ID`);
...
ALTER TABLE prcompmonth DROP FOREIGN KEY FK_prcompmonth_2;

CREATE TABLE PR_PAYMENT_MODE (
  PAYMENT_MODE_ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  PAYMENT_MODE VARCHAR(100) NOT NULL DEFAULT '',
  IS_BANK INTEGER UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY(PAYMENT_MODE_ID),
  UNIQUE uq_prpaymentmode(PAYMENT_MODE)
)ENGINE = InnoDB;

INSERT INTO PR_PAYMENT_MODE (PAYMENT_MODE, IS_BANK) VALUES ('Cash', 0);
INSERT INTO PR_PAYMENT_MODE (PAYMENT_MODE, IS_BANK) VALUES ('Bank', 1);
INSERT INTO PR_PAYMENT_MODE (PAYMENT_MODE, IS_BANK) VALUES ('Cheque', 1);
INSERT INTO PR_PAYMENT_MODE (PAYMENT_MODE, IS_BANK) VALUES ('Society', 1);
INSERT INTO PR_PAYMENT_MODE (PAYMENT_MODE, IS_BANK) VALUES ('NEFT', 1);

ALTER TABLE prstaffgroup ADD COLUMN ACCOUNT_NUMBER VARCHAR(50) AFTER STAFFORDER,
 ADD COLUMN ACCOUNT_IFSC_CODE VARCHAR(50) AFTER ACCOUNT_NUMBER,
 ADD COLUMN ACCOUNT_BANK_BRANCH VARCHAR(150) AFTER ACCOUNT_IFSC_CODE,
 ADD COLUMN PAYMENT_MODE_ID INTEGER UNSIGNED AFTER ACCOUNT_BANK_BRANCH;

UPDATE prstaffgroup pg
INNER JOIN stfpersonal s ON s.staffid = pg.staffid AND pg.ACCOUNT_NUMBER IS NULL
SET pg.ACCOUNT_NUMBER = s.ACCOUNT_NUMBER, pg.ACCOUNT_IFSC_CODE = s.ACCOUNT_IFSC_CODE, pg.ACCOUNT_BANK_BRANCH = s.ACCOUNT_BANK_BRANCH;

ALTER TABLE branch_congregation_ledger ADD COLUMN CON_NATURE_ID INTEGER UNSIGNED NOT NULL DEFAULT 0 AFTER CON_MAIN_PARENT_ID;
UPDATE branch_congregation_ledger SET CON_NATURE_ID = 3 WHERE CON_LEDGER_CODE IN ('A', 'B', 'D01') AND CON_NATURE_ID = 0;
UPDATE branch_congregation_ledger SET CON_NATURE_ID = 4 WHERE CON_LEDGER_CODE IN ('C', 'D02') AND CON_NATURE_ID = 0;
UPDATE branch_congregation_ledger SET CON_NATURE_ID = 2 WHERE CON_LEDGER_CODE IN ('E', 'G') AND CON_NATURE_ID = 0;
UPDATE branch_congregation_ledger SET CON_NATURE_ID = 1 WHERE CON_LEDGER_CODE IN ('F') AND CON_NATURE_ID = 0;

ALTER TABLE branch_congregation_ledger_map ADD COLUMN CON_OP_AMOUNT DECIMAL(15,2) NOT NULL DEFAULT 0.00 AFTER PROJECT_CATOGORY_GROUP_ID,
 ADD COLUMN CON_OP_TRANS_MODE VARCHAR(2) NOT NULL DEFAULT '' COMMENT 'CR-CREDIT, DR-DEBIT' AFTER CON_OP_AMOUNT;
...
-- New Budget Changes
ALTER TABLE master_report_budget_new_projects
 ADD COLUMN `BUDGET_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-With Report' AFTER `ACC_YEAR_ID`,
 ADD COLUMN `SEQUENCE_NO` INTEGER UNSIGNED NOT NULL DEFAULT 1 AFTER `BUDGET_ID`;
...
ALTER TABLE `budget_costcenter` DROP COLUMN `COST_CENTRE_TABLE`, DROP COLUMN `AMOUNT`, DROP COLUMN `SEQUENCE_NO`;

ALTER TABLE `budget_costcenter`
 ADD COLUMN `PROPOSED_AMOUNT` decimal(13,2) NOT NULL DEFAULT '0.00',
 ADD COLUMN `APPROVED_AMOUNT` decimal(13,2) NOT NULL DEFAULT '0.00',
 ADD COLUMN `TRANS_MODE` varchar(2) NOT NULL DEFAULT '';
 
ALTER TABLE `budget_costcenter` ADD CONSTRAINT `FK_BCC` FOREIGN KEY `FK_BCC` (`COST_CENTRE_ID`)
    REFERENCES `master_cost_centre` (`COST_CENTRE_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT;

update asset_item set depreciation_ledger_id =0 where depreciation_ledger_id =1;

ALTER TABLE `asset_item_detail` MODIFY COLUMN `MANUFACTURER_ID` INTEGER UNSIGNED,
 MODIFY COLUMN `LOCATION_ID` INTEGER UNSIGNED,
 MODIFY COLUMN `CUSTODIAN_ID` INTEGER UNSIGNED;

ALTER TABLE `MASTER_LEDGER` ADD COLUMN `CLOSED_BY`
INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 - Closed By Branch Office  1-Closed by Head Office' AFTER `DATE_CLOSED`;

ALTER TABLE `MASTER_PROJECT` ADD COLUMN `CLOSED_BY`
INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 - Closed By Branch Office  1-Closed by Head Office' AFTER `DATE_CLOSED`;

ALTER TABLE `voucher_master_trans` ADD COLUMN `AUTHORIZATION_STATUS` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-Not Authorized  1-Authorized' AFTER `MODIFIED_BY`,
 ADD COLUMN `AUTHORIZATION_UPDATED_ON` DATETIME AFTER `AUTHORIZATION_STATUS`,
 ADD COLUMN `AUTHORIZATION_UPDATED_BY_NAME` VARCHAR(100) NOT NULL DEFAULT '' AFTER `AUTHORIZATION_UPDATED_ON`;

ALTER TABLE `gst_invoice_master` ADD COLUMN `BOOKING_VOUCHER_ID` INTEGER UNSIGNED AFTER `GST_INVOICE_ID`,
 ADD COLUMN `BOOKING_VOUCHER_TYPE` varchar(2) DEFAULT NULL COMMENT 'RC -Receipts,PY -Payments,CN -Contra ,JR -Journal' AFTER `BOOKING_VOUCHER_ID`;
			 
ALTER TABLE gst_invoice_master_details ADD COLUMN `QUANTITY` DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER LEDGER_GST_CLASS_ID,
 ADD COLUMN `UNIT_MEASUREMENT` VARCHAR(50) NOT NULL DEFAULT '' AFTER `QUANTITY`,
 ADD COLUMN `UNIT_AMOUNT` DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER `UNIT_MEASUREMENT`,
 ADD COLUMN `DISCOUNT` DECIMAL(15,2) NOT NULL DEFAULT 0 AFTER `UNIT_AMOUNT`;

INSERT INTO MASTER_SETTING (USER_ID, SETTING_NAME, VALUE)
SELECT UI.USER_ID, 'IncludeIncomeLedgersInBudget' AS SETTING_NAME, 1 AS VALUE
FROM USER_INFO UI
ON DUPLICATE KEY UPDATE VALUE = 1;

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'ATM' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='ATM');

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'Debit Card/Credit Card' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='Debit Card/Credit Card');

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'Prepaid Card/Electronic Card' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='Prepaid Card/Electronic Card');

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'ECS' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='ECS');

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'PO' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='PO');

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'Same Bank/Inter Bank' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='Same Bank/Inter Bank');

INSERT IGNORE INTO MASTER_FUND_TRANSFER_TYPE (FUND_TRANSFER_TYPE_NAME)
SELECT 'Others' from dual WHERE NOT EXISTS (SELECT FUND_TRANSFER_TYPE_name FROM MASTER_FUND_TRANSFER_TYPE WHERE FUND_TRANSFER_TYPE_NAME ='Others');
...
CREATE TABLE `PR_DEPARTMENT` (
  ...
  UNIQUE `UQ_DEPARTMENT`(`DEPARTMENT`)
) ENGINE = InnoDB;

CREATE TABLE `PR_WORK_LOCATION` (
  `WORK_LOCATION_ID` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  `WORK_LOCATION` VARCHAR(100) NOT NULL DEFAULT '',
  PRIMARY KEY(`WORK_LOCATION_ID`),
  UNIQUE `UQ_DEPARTMENT`(`WORK_LOCATION`)
)ENGINE = InnoDB;

CREATE TABLE `PR_NAME_TITLE` (
  `NAME_TITLE_ID` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  `NAME_TITLE` VARCHAR(25) NOT NULL DEFAULT '',
  PRIMARY KEY(`NAME_TITLE_ID`),
  UNIQUE `UQ_NAME_TITLE`(`NAME_TITLE`)
) ENGINE = InnoDB;

ALTER TABLE `stfpersonal` CHANGE COLUMN `DEPTID` `DEPARTMENT_ID` INTEGER UNSIGNED,
 ADD COLUMN `WORK_LOCATION_ID` INTEGER UNSIGNED AFTER `DEPARTMENT_ID`,
 ADD CONSTRAINT `FK_Department` FOREIGN KEY `FK_Department` (`DEPARTMENT_ID`)
    REFERENCES `pr_department` (`DEPARTMENT_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
 ADD CONSTRAINT `FK_WorkLocation` FOREIGN KEY `FK_WorkLocation` (`WORK_LOCATION_ID`)
    REFERENCES `pr_work_location` (`WORK_LOCATION_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
 ADD COLUMN `NAME_TITLE_ID` INTEGER UNSIGNED AFTER `EMPNO`,
 ADD CONSTRAINT `FK_NameTitle` FOREIGN KEY `FK_NameTitle` (`NAME_TITLE_ID`)
    REFERENCES `pr_name_title` (`NAME_TITLE_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT;

ALTER TABLE `prstaffgroup`
 ADD COLUMN `DEPARTMENT_ID` INTEGER UNSIGNED AFTER `GROUPID`,
 ADD COLUMN `WORK_LOCATION_ID` INTEGER UNSIGNED AFTER `DEPARTMENT_ID`,
 ADD CONSTRAINT `FK_GRP_Department` FOREIGN KEY `FK_Department` (`DEPARTMENT_ID`)
    REFERENCES `pr_department` (`DEPARTMENT_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
 ADD CONSTRAINT `FK_GRP_WorkLocation` FOREIGN KEY `FK_WorkLocation` (`WORK_LOCATION_ID`)
    REFERENCES `pr_work_location` (`WORK_LOCATION_ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT;
	
INSERT INTO prtext (TNAME) VALUES ('Department/Unit');
INSERT INTO prtext (TNAME) VALUES ('Work/Job Location');

INSERT INTO `pr_name_title` (`NAME_TITLE_ID`,`NAME_TITLE`) VALUES
 (10,'Br'), (7,'Dr'), (8,'Fr'), (3,'Miss'), (1,'Mr'), (2,'Mrs'),
 (6,'Ms'), (4,'Shri'), (5,'Smt'), (9,'Sr');

 ALTER TABLE `master_report_sign_detail` ADD COLUMN `SIGN_NOTE` VARCHAR(250) NOT NULL DEFAULT '' AFTER `HIDE_REQUIRE_SIGN_NOTE`,
 ADD COLUMN `SIGN_NOTE_ALIGNMENT` INTEGER UNSIGNED NOT NULL DEFAULT 1 COMMENT '0-Left,1-Centre,2-Right' AFTER `SIGN_NOTE` ,
 ADD COLUMN `SIGN_NOTE_LOCATION` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-Above Signature,1-Below Signature' AFTER `SIGN_NOTE_ALIGNMENT`;
 ALTER TABLE master_report_budget_new_projects DROP INDEX `UQ_NEW_PROJECT`,
 ADD UNIQUE `UQ_NEW_PROJECT` USING BTREE(`NEW_PROJECT`, `BUDGET_ID`);

ALTER TABLE `prcomponent` ADD COLUMN `DONT_IMPORT_MODIFIED_VALUE_PREV_PR` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0- Import from previous PR 1- Donot Import modified value form previous PR' AFTER `ISEDITABLE`;
UPDATE `prcomponent` SET DONT_IMPORT_MODIFIED_VALUE_PREV_PR = 1 WHERE ISEDITABLE=1;
ALTER TABLE FD_RENEWAL ADD COLUMN FD_TRANS_MODE varchar(2) NOT NULL DEFAULT 'DR' AFTER REINVESTED_AMOUNT;

ALTER TABLE `master_setting` MODIFY COLUMN `VALUE` VARCHAR(250) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';
...
INSERT INTO `master_investment_type` (`INVESTMENT_TYPE_ID`,`INVESTMENT_TYPE`) VALUES
 (1,'FD'), (2,'RD - Post Office'), (3,'RD - Bank'),  (4,'Mutual Fund');

ALTER TABLE `fd_account` ADD COLUMN `MF_FOLIO_NO` VARCHAR(100) NOT NULL DEFAULT '' AFTER `EXPECTED_INTEREST_VALUE`,
 ADD COLUMN `MF_SCHEME_NAME` VARCHAR(150) NOT NULL DEFAULT '' AFTER `MF_FOLIO_NO`,
 ADD COLUMN `MF_NAV_PER_UNIT` DOUBLE NOT NULL DEFAULT 0 AFTER `MF_SCHEME_NAME`,
 ADD COLUMN `MF_NO_OF_UNITS` DOUBLE NOT NULL DEFAULT 0 AFTER `MF_NAV_PER_UNIT`,
 ADD COLUMN `MF_MODE_OF_HOLDING` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 - Single 1- Joint' AFTER `MF_NO_OF_UNITS`;

ALTER TABLE `master_ledger` ADD COLUMN `FD_INVESTMENT_TYPE_ID` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-None' AFTER `LEDGER_SUB_TYPE`;

UPDATE MASTER_LEDGER SET FD_INVESTMENT_TYPE_ID = 1 WHERE LEDGER_SUB_TYPE ='FD' AND FD_INVESTMENT_TYPE_ID = 0;

ALTER TABLE `portal_congregation_ledger` DROP INDEX `CON_LEDGER_CODE`;

-- Multi-Currency database changes on 09/09/2024
...
ALTER TABLE MASTER_LEDGER ADD COLUMN CUR_COUNTRY_ID INTEGER UNSIGNED COMMENT 'Cash Bank Country Currency' AFTER BANK_ACCOUNT_ID,
ADD COLUMN OP_EXCHANGE_RATE decimal(15,2) NOT NULL DEFAULT '0.00' AFTER CUR_COUNTRY_ID;

ALTER TABLE `master_headoffice_ledger` ADD COLUMN `CUR_COUNTRY_ID` INTEGER UNSIGNED COMMENT 'Cash Bank Country Currency' AFTER `BANK_ACCOUNT_ID`,
 ADD COLUMN `OP_EXCHANGE_RATE` decimal(15,2) NOT NULL DEFAULT '0.00' AFTER `CUR_COUNTRY_ID`;

ALTER TABLE `ledger_balance` ADD COLUMN `AMOUNT_FC` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Cash, Bank Balance in their currency' AFTER `AMOUNT`;

ALTER TABLE `voucher_master_trans` ADD COLUMN `IS_MULTI_CURRENCY` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Is multi currency mode' AFTER `VOUCHER_DEFINITION_ID`;

ALTER TABLE FD_ACCOUNT
ADD COLUMN IS_MULTI_CURRENCY INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Is multi currency mode' AFTER TRANS_TYPE,
ADD COLUMN CURRENCY_COUNTRY_ID int(10) unsigned NOT NULL DEFAULT '0' AFTER IS_MULTI_CURRENCY,
ADD COLUMN CONTRIBUTION_AMOUNT decimal(15,2) NOT NULL DEFAULT '0.00' AFTER CURRENCY_COUNTRY_ID,
ADD COLUMN EXCHANGE_RATE decimal(15,2) NOT NULL DEFAULT '0.00' AFTER CONTRIBUTION_AMOUNT,
ADD COLUMN ACTUAL_AMOUNT decimal(15,2) NOT NULL DEFAULT '0.00' AFTER EXCHANGE_RATE;
...
INSERT INTO `master_usermanual_feature` (`FEATURE_CODE`,`FEATURE_GROUP_CODE`,`FEATURE_GROUP`,`FEATURE`,`LINK_FILENAME`) VALUES
 ('PF001','PF','Pay & Get the Feature','Automatic Community Bakcup',''),
 ('PF002','PF','Pay & Get the Feature','Audit Reports',''),
 ('PF003','PF','Pay & Get the Feature','Online Budget Approval',''),
 ('UM001','UM','User Manual','Installation Procedure','Deployment Procedure.pdf'),
 ('UM002','UM','User Manual','Finance','Finance.pdf'),
 ('UM003','UM','User Manual','Finance - Multi Currency','Multi-Currency.pdf'),
 ('UM004','UM','User Manual','Cost Centre','Cost Centre.pdf'),
 ('UM005','UM','User Manual','Budget','Budget.pdf'),
 ('UM006','UM','User Manual','Asset','Fixed Asset.pdf'),
 ('UM007','UM','User Manual','Payroll','Payroll.pdf'),
 ('UM008','UM','User Manual','Utilities','Utilities.pdf'),
 ('UM009','UM','User Manual','Rendiconto Reports','Rendiconto.pdf'),
 ('UM010','UM','User Manual','Training Manual','Training Manual.pdf'),
 ('PF004','PF','Pay & Get the Feature','Attach Vouchers Files (Images and Pdf)','');

UPDATE ACTIVITIY_RIGHTS SET OBJECT_TYPE ="TDS",OBJECT_SUB_TYPE ="TDS" where parent_id in (272,16,67,72,77,320,321);
...
INSERT INTO master_project_catogory_ITRGroup (PROJECT_CATOGORY_ITRGROUP_ID,PROJECT_CATOGORY_ITRGROUP) VALUES (1,"Primary");
INSERT INTO master_project_catogory_ITRGroup (PROJECT_CATOGORY_ITRGROUP_ID,PROJECT_CATOGORY_ITRGROUP) VALUES (2,"Religious");
INSERT INTO master_project_catogory_ITRGroup (PROJECT_CATOGORY_ITRGROUP_ID,PROJECT_CATOGORY_ITRGROUP) VALUES (3,"Relief of the poor");
INSERT INTO master_project_catogory_ITRGroup (PROJECT_CATOGORY_ITRGROUP_ID,PROJECT_CATOGORY_ITRGROUP) VALUES (4,"Education");
INSERT INTO master_project_catogory_ITRGroup (PROJECT_CATOGORY_ITRGROUP_ID,PROJECT_CATOGORY_ITRGROUP) VALUES (5,"Medical Relief");
INSERT INTO master_project_catogory_ITRGroup (PROJECT_CATOGORY_ITRGROUP_ID,PROJECT_CATOGORY_ITRGROUP) VALUES (6,"Yoga");

ALTER TABLE `master_project_catogory` ADD COLUMN `PROJECT_CATOGORY_GROUP_ID` INTEGER(50) UNSIGNED AFTER `PROJECT_CATOGORY_NAME`;
ALTER TABLE `master_project_catogory` ADD COLUMN `PROJECT_CATOGORY_ITRGROUP_ID` INT(50) NULL DEFAULT 1 AFTER `PROJECT_CATOGORY_GROUP_ID`;

ALTER TABLE MASTER_LEDGER ADD COLUMN OP_EXCHANGE_RATE decimal(15,2) NOT NULL DEFAULT '0.00' AFTER CUR_COUNTRY_ID;

DELETE LB.* FROM LEDGER_BALANCE LB
...
ALTER TABLE `master_executive_committee` ADD COLUMN `AADHAR_NO` VARCHAR(12) NOT NULL DEFAULT '' AFTER `PAN_SSN`;

ALTER TABLE `master_executive_committee` MODIFY COLUMN `NATIONALITY` VARCHAR(25) CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE `master_bank` ADD COLUMN `BSRCODE` VARCHAR(25) AFTER `ADDRESS`;

ALTER TABLE `master_bank_account` ADD COLUMN `TYPE_ID` INTEGER UNSIGNED COMMENT 'Saving Account, Current Account' AFTER `ACCOUNT_TYPE_ID`;

ALTER TABLE `asset_item` MODIFY COLUMN `PREFIX` VARCHAR(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '';
...
ALTER TABLE `master_project_catogory` 
ADD COLUMN `PROJECT_CATOGORY_ITRGROUP_ID` INT(50) NULL DEFAULT 1 AFTER `PROJECT_CATOGORY_GROUP_ID`;

ALTER TABLE `ledger_balance` ADD COLUMN `TRANS_FC_MODE` VARCHAR(2) NOT NULL DEFAULT '' COMMENT 'CR-CREDIT, DR-DEBIT' AFTER `TRANS_MODE`;
UPDATE `ledger_balance` LB SET LB.TRANS_FC_MODE = LB.TRANS_MODE WHERE (LB.TRANS_FC_MODE ='' OR LB.TRANS_FC_MODE IS NULL);

ALTER TABLE `voucher_trans`
ADD COLUMN `LIVE_EXCHANGE_RATE` decimal(15,2) NOT NULL DEFAULT '0.00' AFTER `TRANS_MODE`,
ADD COLUMN `EXCHANGE_RATE` decimal(15,2) NOT NULL DEFAULT '0.00' AFTER `LIVE_EXCHANGE_RATE`,
ADD COLUMN `ACTUAL_AMOUNT` decimal(15,2) NOT NULL DEFAULT '0.00' AFTER `EXCHANGE_RATE`;

UPDATE VOUCHER_TRANS VT
INNER JOIN voucher_master_trans VM ON VM.VOUCHER_ID = VT.VOUCHER_ID
SET VT.EXCHANGE_RATE= VM.EXCHANGE_RATE, LIVE_EXCHANGE_RATE = VM.EXCHANGE_RATE,
VT.ACTUAL_AMOUNT= (VT.AMOUNT * IF(VM.EXCHANGE_RATE = 0 OR VM.EXCHANGE_RATE IS NULL, 1, VM.EXCHANGE_RATE))
WHERE VM.IS_MULTI_CURRENCY = 1 AND VT.EXCHANGE_RATE = 0;

INSERT INTO `master_investment_type` (`INVESTMENT_TYPE_ID`,`INVESTMENT_TYPE`) VALUES
 (5,'Tresery Bills and Bonds'), (6,'Money Market'), (7,'Unit Trust'),  (8,'Investments');

ALTER TABLE `asset_in_out_detail` ADD COLUMN `BALANCE_OP_DATE` DATETIME AFTER `BRANCH_ID`;

ALTER TABLE `gst_invoice_master_details` ADD COLUMN `ITEM_NAME` VARCHAR(150) NOT NULL DEFAULT '' AFTER `LEDGER_ID`,
 ADD COLUMN `ITEM_DESCRIPTION` VARCHAR(200) NOT NULL DEFAULT '' AFTER `ITEM_NAME`;

ALTER TABLE `gst_invoice_master` ADD COLUMN `DUE_DATE` DATETIME AFTER `SUPPLY_DATE`;

ALTER TABLE `gst_invoice_master` CHARACTER SET utf8 COLLATE utf8_general_ci;

ALTER TABLE `gst_invoice_master_details` MODIFY COLUMN `ITEM_NAME` VARCHAR(150) NOT NULL DEFAULT '',
 MODIFY COLUMN `ITEM_DESCRIPTION` VARCHAR(200) NOT NULL DEFAULT '',
 MODIFY COLUMN `UNIT_MEASUREMENT` VARCHAR(50) NOT NULL DEFAULT '',
 MODIFY COLUMN `TRANS_MODE` VARCHAR(5) NOT NULL DEFAULT '' COMMENT 'CR- CREDIT, DR-DEBIT',
 MODIFY COLUMN `GST_HSN_SAC_CODE` VARCHAR(25) NOT NULL DEFAULT '';

ALTER TABLE `gst_invoice_master` MODIFY COLUMN `BOOKING_VOUCHER_TYPE` VARCHAR(2) COMMENT 'RC -Receipts,PY -Payments,CN -Contra ,JR -Journal',
 MODIFY COLUMN `GST_VENDOR_INVOICE_NO` VARCHAR(25) COMMENT 'Vendor GST invoice no',
 MODIFY COLUMN `TRANSPORT_MODE` VARCHAR(100),
 MODIFY COLUMN `VEHICLE_NUMBER` VARCHAR(100),
 MODIFY COLUMN `SUPPLY_PLACE` VARCHAR(100),
 MODIFY COLUMN `BILLING_NAME` VARCHAR(100),
 MODIFY COLUMN `BILLING_GST_NO` VARCHAR(25),
 MODIFY COLUMN `BILLING_ADDRESS` VARCHAR(200),
 MODIFY COLUMN `SHIPPING_NAME` VARCHAR(100),
 MODIFY COLUMN `SHIPPING_GST_NO` VARCHAR(25),
 MODIFY COLUMN `SHIPPING_ADDRESS` VARCHAR(200),
 MODIFY COLUMN `CHEQUE_IN_FAVOUR` VARCHAR(100);

 ALTER TABLE `voucher_master_trans` ADD COLUMN `PAN_NUMBER` VARCHAR(30) AFTER `CLIENT_MODE`,
 ADD COLUMN `GST_NUMBER` VARCHAR(30) AFTER `PAN_NUMBER`;
