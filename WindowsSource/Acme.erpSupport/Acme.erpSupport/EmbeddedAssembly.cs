...
namespace Acme.erpSupport
{
    ...
    public class EmbeddedAssembly
    {
        ...
        public static bool Load(string embeddedResource, string fileName)
        {
            ...
            {
                Rtn = false;
                MessageRender.ShowMessage("MySQL component is missing in AcMEERP Updater, Contact BoscoSoft Admin " + err.Message, true);
            }
            return Rtn;
        }
        ...
        public static Assembly Get(string assemblyFullName)
        {
            ...
            {
                MessageRender.ShowMessage ("MySQL component is missing in AcMEERP Updater, Contact BoscoSoft Admin", true);
            }
            return rtnAssembly;
        }
    }
