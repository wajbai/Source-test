...
{
    public partial class frmAssetCategoriesAdd : frmBaseAdd
    {
        ...
        #region Constructor
        public frmAssetCategoriesAdd()
        {
            InitializeComponent();
        }

        public frmAssetCategoriesAdd(int CategoryId, FinanceModule module)
            : this()
        {
        ...
        #region Methods
        /// <summary>
        /// Load asset group details to grid control.
        /// </summary>
