...
{
    public partial class frmInsuranceVoucherView : frmBase
    {
        public frmInsuranceVoucherView()
        {
            InitializeComponent();
        }

        private void frmInsuranceVoucherView_Load(object sender, EventArgs e)
        {
        ...
        {
            frmInsuranceVoucherAdd objInsurance = new frmInsuranceVoucherAdd();
