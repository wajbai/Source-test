...
{
    public partial class frmAssetClassView : frmBase
    {
       ...
       // AssetStockProduct.IGroup Igroup;
        ...
        {
            ShowAssetClassDetails(AssetClassId);
        }
        ...
        private string FetchSelectedGroup()
        {
            ...
            try
            {
                ...
                {
                    groupSystem.AssetClassId = AssetClassId;
        ...
        private void ShowAssetClassDetails(int ClassId)
        {
            try
            {
                frmAssetClassAdd assetClassItem = new frmAssetClassAdd(ClassId);
                assetClassItem.UpdateHeld += new EventHandler(OnUpdateHeld);
                TempAsseGroupId = assetClassItem.ClassId;
        ...
        private void LoadGroupList(string ClassId)
        {
            ResultArgs resultArgs = new ResultArgs();
            try
            {
