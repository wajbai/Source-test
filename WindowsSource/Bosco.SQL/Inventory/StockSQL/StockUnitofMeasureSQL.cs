...
{
                        query = "INSERT INTO ASSET_STOCK_UNITOFMEASURE\n" +
                                "  (TYPE,\n" +
                                "   UNITTYPE_ID,\n" +
                                "   SYMBOL,\n" +
                                "   NAME,\n" +
                ...
                case SQLCommand.StockUnitofMeasure.Update:
                    {
                        query = "UPDATE ASSET_STOCK_UNITOFMEASURE SET \n" +
                                "                           TYPE = ?TYPE,\n" +
                ...
                case SQLCommand.StockUnitofMeasure.FetchAll:
                    {
                        query = "SELECT UNIT_ID," +
                                ...
                                "NAME," +
                                "DECIMAL_PLACE " +
                                "FROM ASSET_STOCK_UNITOFMEASURE";
                        break;
                    }
                ...
                case SQLCommand.StockUnitofMeasure.FetchForFirstUnit:
                    {
                        query = "SELECT UNIT_ID, SYMBOL FROM ASSET_STOCK_UNITOFMEASURE WHERE SYMBOL <> ''";
                        break;
                    }

                case SQLCommand.StockUnitofMeasure.Delete:
                    {
                        query = "DELETE FROM ASSET_STOCK_UNITOFMEASURE WHERE UNIT_ID = ?UNIT_ID";
                        break;
                    }
            }
            return query;
