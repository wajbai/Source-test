...
{
    public partial class NetworkingProspectIndividual : Bosco.Report.Base.ReportHeaderBase
    {
        public NetworkingProspectIndividual()
        {
            InitializeComponent();
        }
        ...
        public void BindPropsectInstitutionalDetails()
        {
            ...
            this.SetLandscapeFooterDateWidth = 920.50f;
