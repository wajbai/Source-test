...
{
    public partial class TrackOnVouchersChanges: Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor
        public TrackOnVouchersChanges()
        {
            InitializeComponent();
        ...
        private ResultArgs GetReportSource()
        {
            try
            {
                ...
                using (DataManager dataManager = new DataManager())
                {
                    ...
                    dataManager.Parameters.Add(reportSetting1.AuditLog.IS_AUDITOR_MODIFIEDColumn.ColumnName, "0,1");
