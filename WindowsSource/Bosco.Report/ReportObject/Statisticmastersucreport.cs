...
{
    public partial class Statisticmastersucreport : Bosco.Report.Base.ReportBase
    {
        ResultArgs resultArgs = null;
        public int sum { get; set; }

        public Statisticmastersucreport()
        {
            InitializeComponent();
        }
        ...
        public void BindStaticsDetails()
        {
            ...
            if (dtFARegister != null && dtFARegister.Rows.Count > 0)
            {
                ...
                sum = UtilityMember.NumberSet.ToInteger(dtFARegister.Compute("SUM(MASTER_COUNT)", "").ToString());
            }
