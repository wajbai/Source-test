...
{
    public partial class FixedAssetsRegister : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        #region Methods
        public void BindFixedAssetRegisterSource()
        {
        ...
        {
            ResultArgs resultArgs = null;
            string FixedAssetRegister = this.GetAssetReports(SQL.ReportSQLCommand.Asset.FixedAssetRegister);
