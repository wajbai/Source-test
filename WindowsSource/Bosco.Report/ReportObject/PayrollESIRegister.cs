...
{
    public partial class PayrollESIRegister : ReportHeaderBase
    {
        #region Declaration
        ...
        private void ReportSetting()
        {
            ...
            using (clsPayrollBase paybase = new clsPayrollBase())
            {
                ...
                ResultArgs resultArgs = paybase.GenerateStaffESIRegister(ReportProperty.Current.PayrollGroupId, ReportProperty.Current.PayrollId, ReportProperty.Current.PayrollComponentId);
