...
{
    public partial class MultiCoulmnReceipts : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        //public float pvReceiptWitdh
        //{
        //  //  get { return GetTotalWidth(xrPGDrMuticolumnCashBank); }
        //}

        public MultiCoulmnReceipts()
        {
            InitializeComponent();
        }
            ...
            else
            {
                if (this.UIAppSetting.UICustomizationForm == "1")
                {
                    if (ReportProperty.Current.ReportFlag == 0)
                    {
                        ...
                        dvCashBankBook.RowFilter = "VOUCHER_TYPE='Rcpt'";
