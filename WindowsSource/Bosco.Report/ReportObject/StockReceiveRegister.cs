...
{
    public partial class StockReceiveRegister : Bosco.Report.Base.ReportHeaderBase
    {
        #region Declaration
        ...
        private void SetStockPurchaseReport()
        {
            if (this.ReportProperties.DateFrom != string.Empty || this.ReportProperties.DateTo != string.Empty && this.ReportProperties.Project != "0")
            {
                ...
                this.SetLandscapeHeader = 785.25f;
                this.SetLandscapeFooter = 785.25f;
        ...
        {
            string stockSummary = this.GetReportTDS(SQL.ReportSQLCommand.Stock.StockReceive);
