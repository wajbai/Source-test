...
{
    public partial class MultiAbstractReceiptsPurposeCashBankView : Bosco.Report.Base.ReportHeaderBase
    {
        MultiAbstractReceiptsProjectCashBank multiAbstractReceipts;
        MultiAbstractReceiptsProjectCashBank multiAbstractPayments;

        public MultiAbstractReceiptsPurposeCashBankView()
        {
            InitializeComponent();
        ...
        private void LoadMultiAbstractReport()
        {
            ...
            lblProjectName.Text = ReportProperty.Current.ProjectNamewithITRGroup;
