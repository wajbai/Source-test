...
{
    public partial class MontlyAbstractReceipts : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor

        public MontlyAbstractReceipts()
        {
            InitializeComponent();
            ...
            this.AttachDrillDownToRecord(xrtblLedger, tcLedgerName, 
                new ArrayList { reportSetting1.MonthlyAbstract.LEDGER_IDColumn.ColumnName}, DrillDownType.LEDGER_SUMMARY, false);
        }
        ...
        private void SetReportSetting(DataView dvReceipt, AccountBalance accountBalance)
        {
            ...
            this.SetReportDate = ReportProperties.ReportDate != string.Empty ? ReportProperties.ReportDate : string.Empty;
