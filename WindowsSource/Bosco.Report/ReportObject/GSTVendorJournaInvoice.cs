...
{
    public partial class GSTVendorJournaInvoice : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        private void SetReportSetting()
        {
            ...
            //For Caption 
            xrcellInvoiceNoCaption.Font = xrcellInvoiceDateCaption.Font =  fontCaption;
            xrcellBillNameCaption.Font = fontCaption;
            ...
            xrcellShipStateCodeCaption.Font =  fontCaption;
            xrcellSumTaxValue.Font = xrcellSumCGST.Font = xrcellSumSGST.Font = xrcellTotalSumLedgerAmount.Font = fontCaption;

            xrcellBeforeTaxCaption.Font = xrcellAddCGSTCaption.Font = xrcellAddSGSTCaption.Font = xrcellAddIGSTCaption.Font = xrcellTotalTaxAmountCaption.Font = fontCaption;
            xrcellAfterTaxCaption.Font = xrCellRemarksCaption.Font = fontCaption;
             
            //For Values 
            xrcellInvoiceNo.Font = xrcellInvoiceDate.Font =  fontValue;
            xrcellBillName.Font = xrcellBillAddress.Font = xrcellBillGSTNo.Font = fontValue;
            xrcellBillState.Font = xrcellBillStateCode.Font = xrcellShipName.Font = xrcellShipAddress.Font = xrcellShipGSTNo.Font = fontValue;
            xrcellShipState.Font = xrcellShipStateCode.Font =  xrcellSNo.Font = fontValue;
            xrcellLedgerName.Font = xrcellHSNSACCode.Font = xrcellQty.Font = xrcellUnit.Font = fontValue;
            xrcellDiscount.Font = xrcellTaxableValue.Font = xrcellCGST.Font = xrcellSGST.Font = xrcellAddIGST.Font = xrcellTotalTaxAmount.Font = fontValue;
            xrcellCGSTRate.Font = xrcellSGSTRate.Font = xrcellLedgerTotalAmount.Font = fontValue;
            xrcellBeforeTax.Font = xrcellAddCGST.Font = xrcellAddSGST.Font = xrcellAfterTax.Font =  xrcellTotalTaxAmount.Font = fontValue;
            xrcellChequeFavour.Font = fontValue;
            ...
            xrcellAfterTax.Font =  fontValue;
            xrCellRemarks.Font = fontValue;
        }

        public ResultArgs BindGSTInvoice()
        {
            string CashBankReceipts = this.GetReportCashBankVoucher(SQL.ReportSQLCommand.CashBankVoucher.FetchGSTInvoiceByJournalVoucher);
        ...
        private void xrcellLedgerTotalAmount_EvaluateBinding(object sender, BindingEventArgs e)
        {
            if (this.DataSource != null && GetCurrentColumnValue(this.reportSetting1.GST_MASTER_INVOICE.GST_INVOICE_IDColumn.ColumnName) != null)
            {
                ...
                decimal igst = UtilityMember.NumberSet.ToDecimal(GetCurrentColumnValue(this.reportSetting1.GST_MASTER_INVOICE.IGSTColumn.ColumnName).ToString());
                ...
                e.Value = (ledgertotalamount + cgst + sgst + igst);
            }
        }
        ...
        private void xrcellTaxAmount_EvaluateBinding(object sender, BindingEventArgs e)
        {
            if (this.DataSource !=null && GetCurrentColumnValue(this.reportSetting1.GST_MASTER_INVOICE.GST_INVOICE_IDColumn.ColumnName) != null)
            {
                ...
                Int32 invoiceid = UtilityMember.NumberSet.ToInteger(GetCurrentColumnValue(this.reportSetting1.GST_MASTER_INVOICE.GST_INVOICE_IDColumn.ColumnName).ToString());
                string filter = this.reportSetting1.GST_MASTER_INVOICE.GST_INVOICE_IDColumn.ColumnName + " = " + invoiceid;
                object sumtaxamount =  dtRpt.Compute("SUM(" + this.reportSetting1.GST_MASTER_INVOICE.CGSTColumn.ColumnName + ")" + 
                                        ...
                                        " + SUM(" + this.reportSetting1.GST_MASTER_INVOICE.IGSTColumn.ColumnName + ")", filter);
        ...
        private void xrcellAmountInRupees_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                XRTableCell xrcell = sender as XRTableCell;
                double totalamount= UtilityMember.NumberSet.ToDouble(GetCurrentColumnValue(this.reportSetting1.GST_MASTER_INVOICE.CASH_BANK_AMOUNTColumn.ColumnName).ToString());

                if (totalamount == 0)
                {
                    totalamount = GetTotalInvoiceAmount();
                }
        ...
        private double GetTotalInvoiceAmount()
        {
            ...
            if (this.DataSource != null && GetCurrentColumnValue(this.reportSetting1.GST_MASTER_INVOICE.GST_INVOICE_IDColumn.ColumnName) != null)
            {
                ...
                object amt1 = dtRpt.Compute("SUM(" + this.reportSetting1.GST_MASTER_INVOICE.CGSTColumn.ColumnName + ")", filter);

                object amt2 = dtRpt.Compute(" SUM(" + this.reportSetting1.GST_MASTER_INVOICE.SGSTColumn.ColumnName + ")", filter);

                object amt3 = dtRpt.Compute(" SUM(" + this.reportSetting1.GST_MASTER_INVOICE.IGSTColumn.ColumnName + ")", filter);

                object amt4 = dtRpt.Compute(" SUM(" + this.reportSetting1.GST_MASTER_INVOICE.LEDGER_AMOUNTColumn.ColumnName + ")", filter);

                object amt = dtRpt.Compute("SUM(" + this.reportSetting1.GST_MASTER_INVOICE.CGSTColumn.ColumnName + ")" +
                                        " + SUM(" + this.reportSetting1.GST_MASTER_INVOICE.SGSTColumn.ColumnName + ")" +
                                        " + SUM(" + this.reportSetting1.GST_MASTER_INVOICE.IGSTColumn.ColumnName + ")" +
                                        " + SUM(" + this.reportSetting1.GST_MASTER_INVOICE.LEDGER_AMOUNTColumn.ColumnName + ")", filter);

                if (amt != null)
                {
                    totalinvoice = UtilityMember.NumberSet.ToDouble(amt.ToString());
                }
            }
