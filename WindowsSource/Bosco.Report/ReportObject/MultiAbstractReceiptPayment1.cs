...
{
    public partial class MultiAbstractReceiptPayment :ReportBase
    {
        ResultArgs resultArgs = null;
        public MultiAbstractReceiptPayment()
        {
            InitializeComponent();
        }
        ...
        private void BindReceiptsPaymentSource()
        {
            ...
            else
            {
              ...
              //  lblRPDateFrom.Text = GetMonth[0].ToString() + "-" + Culture + "-" + GetMonth[2].ToString();
               ...
               // lblMRProjectTitle.Text = this.ReportProperties.ProjectTitle;
                if (resultArgs.Success && resultArgs.DataSource.Table != null && resultArgs.DataSource.Table.Rows.Count != 0)
                {
                    pvtMultiReceiptPayment.DataSource = resultArgs.DataSource.Table;
                }
            }
        }
    }
