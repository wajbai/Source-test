...
{
    public partial class TDSReturnAnnualForm26 : Bosco.Report.Base.ReportHeaderBase
    {
        ResultArgs resultArgs = null;
        public TDSReturnAnnualForm26()
        {
            InitializeComponent();
        }
        #region Show Reports
        ...
        private void BindForm26Source()
        {
            try
            {
                ...
                {
                    resultArgs.DataSource.Table.TableName = "Form26";
        ...
        {
            string TDSForm26 = this.GetReportTDS(SQL.ReportSQLCommand.TDS.TDSForm26);
            using (DataManager dataManager = new DataManager())
            {
                ...
                resultArgs = dataManager.FetchData(DAO.Data.DataSource.DataTable, TDSForm26);
            }
            return resultArgs;
        }
        #endregion
        ...
        private void xrTableCell120_SummaryGetResult(object sender, SummaryGetResultEventArgs e)
        {
            double TaxAmount = 70;
            double InsAmount = 10;
            double PenAmount = 20;

            xrTableCell120.Text = ReportProperties.NumberSet.ToNumber(TaxAmount + InsAmount + PenAmount);
        }
