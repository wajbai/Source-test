...
{
    public partial class LabelPrint : Bosco.Report.Base.ReportHeaderBase
    {
        public LabelPrint()
        {
            InitializeComponent();
        ...
        public void BindLabelPrintDetails()
        {
        ...
        private ResultArgs GetReportSource()
        {
            ...
            string ProspectIndividual = this.GetNetWorkingReports(SQL.ReportSQLCommand.NetWorking.LabelPrint);
        ...
        {
            xrtblLabelPrint = AlignHeaderTable(xrtblLabelPrint);
            xrtLabelPrint = AlignContentTable(xrtLabelPrint);
        }
    }
}
