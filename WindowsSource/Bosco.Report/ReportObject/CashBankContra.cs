...
{
    public partial class CashBankContra : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public override void ShowReport()
        {
            ...
            (xrSubSignFooter.ReportSource as SignReportFooter).SignWidth = xrlblTitle.WidthF;
        ...
        #region Method
        public void BindReport(bool FrmVoucerScreen = false)
        {
        ...
        public ResultArgs BindCashBankContra()
        {
            string CashBankContra = this.GetReportCashBankVoucher(SQL.ReportSQLCommand.CashBankVoucher.FetchcashBankContraByVoucher);
            using (DataManager dataManager = new DataManager())
            {
                ...
                resultArgs = dataManager.FetchData(DAO.Data.DataSource.DataTable, CashBankContra);
