...
{
    public partial class MonthlyAbstractPayments1 : ReportBase
    {
        ResultArgs resultArgs = null;
        public MonthlyAbstractPayments1()
        {
            InitializeComponent();
        }
        ...
        {
            string sqlMonthlyAbstractPayment = this.GetReportSQL(SQL.ReportSQLCommand.Report.MonthlyAbstractPayment);
            using (DataManager dataManager = new DataManager())
            {
                ...
                resultArgs = dataManager.FetchData(DAO.Data.DataSource.DataTable, sqlMonthlyAbstractPayment);
            }
            return resultArgs;
        }
        private void BindPaymentSource()
        {
            ...
            else
            {
               ...
               // lblPDateFrom.Text = GetMonth[0].ToString() + "-" + Culture + "-" + GetMonth[2].ToString();
               // lblPDateTo.Text = GetMonth[0].ToString() + "-" + ToCulture + "-" + GetMonth[2].ToString();
               // lblPaymentProjectTitle.Text = this.ReportProperties.ProjectTitle;
