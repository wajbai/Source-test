...
namespace Bosco.Report.ReportObject
{
    public partial class CostCentreLedger : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public void BindReport()
        {
            ...
            grpHeaderCC.Visible = grpFooterCC.Visible = grpHeaderCostcentreCategoryName.Visible = Detail.Visible = ReportFooter.Visible = false;
        ...
        private void xrSumLedgerDr_SummaryGetResult(object sender, SummaryGetResultEventArgs e)
        {
            ...
            {
                /*double ledgeropcr = UtilityMember.NumberSet.ToDouble(this.GetCurrentColumnValue("LEDGER_OP_DR").ToString());
